...
pred exec_simple_enc_A{
    all arbitrary_simple_enc_A : simple_enc_A { some t0,t1 : Timeslot | {
        t1 in t0.(^next)
        ...
        some encg : t0.data | {
            t0.data = encg
            encg.encryptionKey = (KeyPairs.owners.(arbitrary_simple_enc_A.simple_enc_A_b)).(KeyPairs.pairs)
            encg.plaintext = arbitrary_simple_enc_A.simple_enc_A_n1            
        }

        t1.receiver = arbitrary_simple_enc_A
        some encg2 : t1.data | {
            t1.data = encg2
            encg2.encryptionKey = (KeyPairs.owners.(arbitrary_simple_enc_A.simple_enc_A_a)).(KeyPairs.pairs)
            encg2.plaintext = arbitrary_simple_enc_A.simple_enc_A_n2
        }
    }}
}
...
pred exec_simple_enc_B{
    all arbitrary_simple_enc_B : simple_enc_B | { some t0,t1 : Timeslot | {
        t1 in t0.(^next)
        ...
        some encg3: t0.data | {
            t0.data = encg3
            encg3.encryptionKey = (KeyPairs.owners.(arbitrary_simple_enc_B.simple_enc_B_b)).(KeyPairs.pairs)
            encg3.plaintext = arbitrary_simple_enc_B.simple_enc_B_n1
        }        

        t1.sender = arbitrary_simple_enc_B
        some encg4: t1.data | {
            t1.data = encg4
            encg4.encryptionKey = (KeyPairs.owners.(arbitrary_simple_enc_B.simple_enc_B_a)).(KeyPairs.pairs)
            encg4.plaintext = arbitrary_simple_enc_B.simple_enc_B_n2
        }
    }}
}
