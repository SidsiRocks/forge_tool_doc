...
pred exec_small_test_A{
    all arbitrary_small_test_A : small_test_A | { some t0,t1 : Timeslot | {
        t1 in t0.(^next)
        t0 + t1 = sender.arbitrary_small_test_A + receiver.arbitrary_small_test_A
        
        t0.sender = arbitrary_small_test_A
        t0.data = arbitrary_small_test_A.small_test_A_a + arbitrary_small_test_A.small_test_A_n1 
        
        t1.receiver = arbitrary_small_test_A
        t1.data = arbitrary_small_test_A.small_test_A_b + arbitrary_small_test_A.small_test_A_n2
    }}
}
...
pred exec_small_test_B{
    all arbitrary_small_test_B : small_test_B | { some t0,t1 : Timeslot | {
        ...
        t0.data = arbitrary_small_test_B.small_test_B_a + arbitrary_small_test_B.small_test_B_n1

        t1.sender = arbitrary_small_test_B
        t1.data = arbitrary_small_test_B.small_test_B_b + arbitrary_small_test_B.small_test_B_n2
    }}
}
