    ...
    all arbitrary_two_nonce_resp : two_nonce_resp | {
        some t0,t1,t2 : Timeslot | {
            ...
            some enc1 : t0.data | {
                ...
                ((enc1).plaintext) = arbitrary_two_nonce_resp.two_nonce_resp_n1
            }
            some enc2 : t1.data | {
                t1.data = enc2
                getPUBK[arbitrary_two_nonce_resp.two_nonce_resp_a] = (enc2).encryptionKey
                some atom3,atom4 : ((enc2).plaintext) {
                    ((enc2).plaintext) = atom3 + atom4                     
                    atom3 = arbitrary_two_nonce_resp.two_nonce_resp_n1
                    atom4 = arbitrary_two_nonce_resp.two_nonce_resp_n2
                }
            }
            some enc5 : t2.data | {
                t2.data = enc5
                getPUBK[arbitrary_two_nonce_resp.two_nonce_resp_b] = (enc5).encryptionKey
                ((enc5).plaintext) = arbitrary_two_nonce_resp.two_nonce_resp_n2
            }
        }
    }
}
    ...
    all arbitrary_two_nonce_init : two_nonce_init | {
        some t0,t1,t2 : Timeslot | {
            ...
            some enc6 : t0.data | {
                ...
                ((enc6).plaintext) = arbitrary_two_nonce_init.two_nonce_init_n1
            }
            some enc7 : t1.data | {
                t1.data = enc7
                getPUBK[arbitrary_two_nonce_init.two_nonce_init_a] = (enc7).encryptionKey
                some atom8,atom9 : ((enc7).plaintext) {
                    ((enc7).plaintext) = atom8 + atom9                     
                    atom8 = arbitrary_two_nonce_init.two_nonce_init_n1
                    atom9 = arbitrary_two_nonce_init.two_nonce_init_n2
                }
            }
            some enc10 : t2.data | {
                t2.data = enc10
                getPUBK[arbitrary_two_nonce_init.two_nonce_init_b] = (enc10).encryptionKey
                ((enc10).plaintext) = arbitrary_two_nonce_init.two_nonce_init_n2
            }
        }
    }
}
