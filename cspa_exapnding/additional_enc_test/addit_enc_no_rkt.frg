...
pred exec_addit_enc_A{
    all arbitrary_addit_enc_A : addit_enc_A | { some t0,t1 : Timeslot | {
        t1 in t0.(^next)
        t0 + t1 = sender.arbitrary_addit_enc_A + receiver.arbitrary_addit_enc_A

        t0.sender = arbitrary_addit_enc_A
        some encg : t0.data | {
            t0.data = arbitrary_addit_enc_A.addit_enc_A_a + encg            
            encg.encryptionKey = (KeyPairs.owners.(arbitrary_addit_enc_A.addit_enc_A_b)).(KeyPairs.pairs)
            encg.plaintext = arbitrary_addit_enc_A.addit_enc_A_n1            
        }  
        
        t1.receiver = arbitrary_addit_enc_A
        some encg2: t1.data | {
            t1.data = arbitrary_addit_enc_A.addit_enc_A_b + encg2
            encg2.encryptionKey = (KeyPairs.owners.(arbitrary_addit_enc_A.addit_enc_A_a)).(KeyPairs.pairs)
            encg2.plaintext = arbitrary_addit_enc_A.addit_enc_A_n2            
        }
    }}
}
...
pred exec_addit_enc_B{
    all arbitrary_addit_enc_B : addit_enc_B | { some t0,t1 : Timeslot | {
        t1 in t0.(^next)
        t0 + t1 = sender.arbitrary_addit_enc_B + receiver.arbitrary_addit_enc_B
        
        t0.receiver = arbitrary_addit_enc_B
        some encg : t0.data | {
            t0.data = arbitrary_addit_enc_B.addit_enc_B_a + encg
            encg.encryptionKey = ((KeyPairs.owners).(arbitrary_addit_enc_B.addit_enc_B_b)).(KeyPairs.pairs)
            encg.plaintext = arbitrary_addit_enc_B.addit_enc_B_n1            
        }

        t1.sender = arbitrary_addit_enc_B
        some encg2 : t1.data | {
            t1.data = arbitrary_addit_enc_B.addit_enc_B_b + encg2
            encg2.encryptionKey = ((KeyPairs.owners).(arbitrary_addit_enc_B.addit_enc_B_a)).(KeyPairs.pairs)
            encg2.plaintext = arbitrary_addit_enc_B.addit_enc_B_n2
        }  
    }}
}
