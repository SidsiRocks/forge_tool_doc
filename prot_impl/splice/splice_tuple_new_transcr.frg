...
sig splice_client extends strand {
  splice_client_c : one name,
  splice_client_s : one name,
  splice_client_as : one name,
  splice_client_N1 : one text,
  splice_client_N2 : one text,
  splice_client_N3 : one text,
  splice_client_T : one text,
  splice_client_L : one text
}
pred exec_splice_client {
  all arbitrary_client_splice : splice_client | {
    no aStrand : strand | {
      originates[aStrand,getPRIVK[arbitrary_client_splice.splice_client_c]] or generates [aStrand,getPRIVK[arbitrary_client_splice.splice_client_c]]
    }
    (generated_times.Timeslot).(arbitrary_client_splice.splice_client_N1) = arbitrary_client_splice.agent
    (generated_times.Timeslot).(arbitrary_client_splice.splice_client_N2) = arbitrary_client_splice.agent
    (generated_times.Timeslot).(arbitrary_client_splice.splice_client_T) = arbitrary_client_splice.agent
    (generated_times.Timeslot).(arbitrary_client_splice.splice_client_L) = arbitrary_client_splice.agent
    arbitrary_client_splice.splice_client_c != arbitrary_client_splice.splice_client_s
    arbitrary_client_splice.splice_client_as != arbitrary_client_splice.splice_client_s
    arbitrary_client_splice.splice_client_c != arbitrary_client_splice.splice_client_as
    arbitrary_client_splice.splice_client_T != arbitrary_client_splice.splice_client_L
    arbitrary_client_splice.splice_client_T != arbitrary_client_splice.splice_client_N1
    arbitrary_client_splice.splice_client_T != arbitrary_client_splice.splice_client_N2
    arbitrary_client_splice.splice_client_T != arbitrary_client_splice.splice_client_N3
    arbitrary_client_splice.splice_client_L != arbitrary_client_splice.splice_client_N1
    arbitrary_client_splice.splice_client_L != arbitrary_client_splice.splice_client_N2
    arbitrary_client_splice.splice_client_L != arbitrary_client_splice.splice_client_N3
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
      ((arbitrary_client_splice.splice_client_N1)->t0 + (arbitrary_client_splice.splice_client_N2)->t2 + (arbitrary_client_splice.splice_client_T)->t2 + (arbitrary_client_splice.splice_client_L)->t2) in (arbitrary_client_splice.agent).generated_times
      t0+t1+t2+t3 = sender.arbitrary_client_splice + receiver.arbitrary_client_splice
      t0.sender = arbitrary_client_splice
      ...
      let text_3  = (((t0.data).components))[2] | {
        ...
        name_1 = arbitrary_client_splice.splice_client_c
        name_2 = arbitrary_client_splice.splice_client_s
        text_3 = arbitrary_client_splice.splice_client_N1
      }}}

      t1.receiver = arbitrary_client_splice
      ...
      let enc_5  = (((t1.data).components))[1] | {
        ...
        name_4 = arbitrary_client_splice.splice_client_as
        learnt_term_by[getPUBK[arbitrary_client_splice.splice_client_as],arbitrary_client_splice.agent,t1]
        inds[(enc_5).plaintext.components] = 0+1+2+3
        let name_10  = ((enc_5).plaintext.components)[0] | {
        let name_11  = ((enc_5).plaintext.components)[1] | {
        let text_12  = ((enc_5).plaintext.components)[2] | {
        let pubk_13  = ((enc_5).plaintext.components)[3] | {
          (enc_5).plaintext.components = 0->name_10 + 1->name_11 + 2->text_12 + 3->pubk_13
          name_10 = arbitrary_client_splice.splice_client_as
          name_11 = arbitrary_client_splice.splice_client_c
          text_12 = arbitrary_client_splice.splice_client_N1
          pubk_13 = getPUBK[arbitrary_client_splice.splice_client_s]
        }}}}
        (enc_5).encryptionKey = getPRIVK[arbitrary_client_splice.splice_client_as]
      }}

      t2.sender = arbitrary_client_splice
      inds[((t2.data).components)] = 0+1+2
      let name_14  = (((t2.data).components))[0] | {
      let name_15  = (((t2.data).components))[1] | {
      let enc_16  = (((t2.data).components))[2] | {
        ((t2.data).components) = 0->name_14 + 1->name_15 + 2->enc_16
        name_14 = arbitrary_client_splice.splice_client_c
        name_15 = arbitrary_client_splice.splice_client_s
        inds[(enc_16).plaintext.components] = 0+1+2+3
        let name_21  = ((enc_16).plaintext.components)[0] | {
        let text_22  = ((enc_16).plaintext.components)[1] | {
        let text_23  = ((enc_16).plaintext.components)[2] | {
        let enc_24  = ((enc_16).plaintext.components)[3] | {
          (enc_16).plaintext.components = 0->name_21 + 1->text_22 + 2->text_23 + 3->enc_24
          name_21 = arbitrary_client_splice.splice_client_c
          text_22 = arbitrary_client_splice.splice_client_T
          text_23 = arbitrary_client_splice.splice_client_L
          inds[(enc_24).plaintext.components] = 0
          let text_26  = ((enc_24).plaintext.components)[0] | {
            (enc_24).plaintext.components = 0->text_26
            text_26 = arbitrary_client_splice.splice_client_N2
          }
          (enc_24).encryptionKey = getPUBK[arbitrary_client_splice.splice_client_s]
        }}}}
        (enc_16).encryptionKey = getPRIVK[arbitrary_client_splice.splice_client_c]
      }}}

      t3.receiver = arbitrary_client_splice
      inds[((t3.data).components)] = 0+1+2
      let name_27  = (((t3.data).components))[0] | {
      let name_28  = (((t3.data).components))[1] | {
      let enc_29  = (((t3.data).components))[2] | {
        ((t3.data).components) = 0->name_27 + 1->name_28 + 2->enc_29
        name_27 = arbitrary_client_splice.splice_client_s
        name_28 = arbitrary_client_splice.splice_client_c
        learnt_term_by[getPRIVK[arbitrary_client_splice.splice_client_c],arbitrary_client_splice.agent,t3]
        inds[(enc_29).plaintext.components] = 0+1
        let name_32  = ((enc_29).plaintext.components)[0] | {
        let hash_33  = ((enc_29).plaintext.components)[1] | {
          (enc_29).plaintext.components = 0->name_32 + 1->hash_33
          name_32 = arbitrary_client_splice.splice_client_s
          (hash_33).hash_of = arbitrary_client_splice.splice_client_N2
        }}
        (enc_29).encryptionKey = getPUBK[arbitrary_client_splice.splice_client_c]
      }}}

    }}}}
  }
}
sig splice_authority extends strand {
  splice_authority_c : one name,
  splice_authority_s : one name,
  splice_authority_as : one name,
  splice_authority_N1 : one text,
  splice_authority_N2 : one text,
  splice_authority_N3 : one text,
  splice_authority_T : one text,
  splice_authority_L : one text
}
pred exec_splice_authority {
  all arbitrary_authority_splice : splice_authority | {
    no aStrand : strand | {
      originates[aStrand,getPRIVK[arbitrary_authority_splice.splice_authority_as]] or generates [aStrand,getPRIVK[arbitrary_authority_splice.splice_authority_as]]
    }
    arbitrary_authority_splice.splice_authority_c != arbitrary_authority_splice.splice_authority_s
    arbitrary_authority_splice.splice_authority_as != arbitrary_authority_splice.splice_authority_s
    arbitrary_authority_splice.splice_authority_c != arbitrary_authority_splice.splice_authority_as
    arbitrary_authority_splice.splice_authority_T != arbitrary_authority_splice.splice_authority_L
    arbitrary_authority_splice.splice_authority_T != arbitrary_authority_splice.splice_authority_N1
    arbitrary_authority_splice.splice_authority_T != arbitrary_authority_splice.splice_authority_N2
    arbitrary_authority_splice.splice_authority_T != arbitrary_authority_splice.splice_authority_N3
    arbitrary_authority_splice.splice_authority_L != arbitrary_authority_splice.splice_authority_N1
    arbitrary_authority_splice.splice_authority_L != arbitrary_authority_splice.splice_authority_N2
    arbitrary_authority_splice.splice_authority_L != arbitrary_authority_splice.splice_authority_N3
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
      t0+t1+t2+t3 = sender.arbitrary_authority_splice + receiver.arbitrary_authority_splice
      t0.receiver = arbitrary_authority_splice
      inds[((t0.data).components)] = 0+1+2
      ...
      let text_36  = (((t0.data).components))[2] | {
        ...
        name_34 = arbitrary_authority_splice.splice_authority_c
        name_35 = arbitrary_authority_splice.splice_authority_s
        text_36 = arbitrary_authority_splice.splice_authority_N1
      }}}

      t1.sender = arbitrary_authority_splice
      inds[((t1.data).components)] = 0+1
      let name_37  = (((t1.data).components))[0] | {
      let enc_38  = (((t1.data).components))[1] | {
        ((t1.data).components) = 0->name_37 + 1->enc_38
        name_37 = arbitrary_authority_splice.splice_authority_as
        inds[(enc_38).plaintext.components] = 0+1+2+3
        let name_43  = ((enc_38).plaintext.components)[0] | {
        let name_44  = ((enc_38).plaintext.components)[1] | {
        let text_45  = ((enc_38).plaintext.components)[2] | {
        let pubk_46  = ((enc_38).plaintext.components)[3] | {
          (enc_38).plaintext.components = 0->name_43 + 1->name_44 + 2->text_45 + 3->pubk_46
          name_43 = arbitrary_authority_splice.splice_authority_as
          name_44 = arbitrary_authority_splice.splice_authority_c
          text_45 = arbitrary_authority_splice.splice_authority_N1
          pubk_46 = getPUBK[arbitrary_authority_splice.splice_authority_s]
        }}}}
        (enc_38).encryptionKey = getPRIVK[arbitrary_authority_splice.splice_authority_as]
      }}

      t2.receiver = arbitrary_authority_splice
      inds[((t2.data).components)] = 0+1+2
      let name_47  = (((t2.data).components))[0] | {
      let name_48  = (((t2.data).components))[1] | {
      let text_49  = (((t2.data).components))[2] | {
        ((t2.data).components) = 0->name_47 + 1->name_48 + 2->text_49
        name_47 = arbitrary_authority_splice.splice_authority_s
        name_48 = arbitrary_authority_splice.splice_authority_c
        text_49 = arbitrary_authority_splice.splice_authority_N3
      }}}

      t3.sender = arbitrary_authority_splice
      inds[((t3.data).components)] = 0+1
      let name_50  = (((t3.data).components))[0] | {
      let enc_51  = (((t3.data).components))[1] | {
        ((t3.data).components) = 0->name_50 + 1->enc_51
        name_50 = arbitrary_authority_splice.splice_authority_as
        inds[(enc_51).plaintext.components] = 0+1+2+3
        let name_56  = ((enc_51).plaintext.components)[0] | {
        let name_57  = ((enc_51).plaintext.components)[1] | {
        let text_58  = ((enc_51).plaintext.components)[2] | {
        let pubk_59  = ((enc_51).plaintext.components)[3] | {
          (enc_51).plaintext.components = 0->name_56 + 1->name_57 + 2->text_58 + 3->pubk_59
          name_56 = arbitrary_authority_splice.splice_authority_as
          name_57 = arbitrary_authority_splice.splice_authority_s
          text_58 = arbitrary_authority_splice.splice_authority_N3
          pubk_59 = getPUBK[arbitrary_authority_splice.splice_authority_c]
        }}}}
        (enc_51).encryptionKey = getPRIVK[arbitrary_authority_splice.splice_authority_as]
      }}

    }}}}
  }
}
sig splice_server extends strand {
  splice_server_c : one name,
  splice_server_s : one name,
  splice_server_as : one name,
  splice_server_N1 : one text,
  splice_server_N2 : one text,
  splice_server_N3 : one text,
  splice_server_T : one text,
  splice_server_L : one text
}
pred exec_splice_server {
  all arbitrary_server_splice : splice_server | {
    no aStrand : strand | {
      originates[aStrand,getPRIVK[arbitrary_server_splice.splice_server_s]] or generates [aStrand,getPRIVK[arbitrary_server_splice.splice_server_s]]
    }
    (generated_times.Timeslot).(arbitrary_server_splice.splice_server_N3) = arbitrary_server_splice.agent
    arbitrary_server_splice.splice_server_c != arbitrary_server_splice.splice_server_s
    arbitrary_server_splice.splice_server_as != arbitrary_server_splice.splice_server_s
    arbitrary_server_splice.splice_server_c != arbitrary_server_splice.splice_server_as
    arbitrary_server_splice.splice_server_T != arbitrary_server_splice.splice_server_L
    arbitrary_server_splice.splice_server_T != arbitrary_server_splice.splice_server_N1
    arbitrary_server_splice.splice_server_T != arbitrary_server_splice.splice_server_N2
    arbitrary_server_splice.splice_server_T != arbitrary_server_splice.splice_server_N3
    arbitrary_server_splice.splice_server_L != arbitrary_server_splice.splice_server_N1
    arbitrary_server_splice.splice_server_L != arbitrary_server_splice.splice_server_N2
    arbitrary_server_splice.splice_server_L != arbitrary_server_splice.splice_server_N3
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
      ((arbitrary_server_splice.splice_server_N3)->t1) in (arbitrary_server_splice.agent).generated_times
      t0+t1+t2+t3 = sender.arbitrary_server_splice + receiver.arbitrary_server_splice
      t0.receiver = arbitrary_server_splice
      inds[((t0.data).components)] = 0+1+2
      let name_60  = (((t0.data).components))[0] | {
      let name_61  = (((t0.data).components))[1] | {
      let enc_62  = (((t0.data).components))[2] | {
        ((t0.data).components) = 0->name_60 + 1->name_61 + 2->enc_62
        name_60 = arbitrary_server_splice.splice_server_c
        name_61 = arbitrary_server_splice.splice_server_s
        learnt_term_by[getPUBK[arbitrary_server_splice.splice_server_c],arbitrary_server_splice.agent,t0]
        inds[(enc_62).plaintext.components] = 0+1+2+3
        let name_67  = ((enc_62).plaintext.components)[0] | {
        let text_68  = ((enc_62).plaintext.components)[1] | {
        let text_69  = ((enc_62).plaintext.components)[2] | {
        let enc_70  = ((enc_62).plaintext.components)[3] | {
          (enc_62).plaintext.components = 0->name_67 + 1->text_68 + 2->text_69 + 3->enc_70
          name_67 = arbitrary_server_splice.splice_server_c
          text_68 = arbitrary_server_splice.splice_server_T
          text_69 = arbitrary_server_splice.splice_server_L
          learnt_term_by[getPRIVK[arbitrary_server_splice.splice_server_s],arbitrary_server_splice.agent,t0]
          inds[(enc_70).plaintext.components] = 0
          let text_72  = ((enc_70).plaintext.components)[0] | {
            (enc_70).plaintext.components = 0->text_72
            text_72 = arbitrary_server_splice.splice_server_N2
          }
          (enc_70).encryptionKey = getPUBK[arbitrary_server_splice.splice_server_s]
        }}}}
        (enc_62).encryptionKey = getPRIVK[arbitrary_server_splice.splice_server_c]
      }}}

      t1.sender = arbitrary_server_splice
      inds[((t1.data).components)] = 0+1+2
      let name_73  = (((t1.data).components))[0] | {
      let name_74  = (((t1.data).components))[1] | {
      let text_75  = (((t1.data).components))[2] | {
        ((t1.data).components) = 0->name_73 + 1->name_74 + 2->text_75
        name_73 = arbitrary_server_splice.splice_server_s
        name_74 = arbitrary_server_splice.splice_server_c
        text_75 = arbitrary_server_splice.splice_server_N3
      }}}

      t2.receiver = arbitrary_server_splice
      inds[((t2.data).components)] = 0+1
      let name_76  = (((t2.data).components))[0] | {
      let enc_77  = (((t2.data).components))[1] | {
        ((t2.data).components) = 0->name_76 + 1->enc_77
        name_76 = arbitrary_server_splice.splice_server_as
        learnt_term_by[getPUBK[arbitrary_server_splice.splice_server_as],arbitrary_server_splice.agent,t2]
        inds[(enc_77).plaintext.components] = 0+1+2+3
        let name_82  = ((enc_77).plaintext.components)[0] | {
        let name_83  = ((enc_77).plaintext.components)[1] | {
        let text_84  = ((enc_77).plaintext.components)[2] | {
        let pubk_85  = ((enc_77).plaintext.components)[3] | {
          (enc_77).plaintext.components = 0->name_82 + 1->name_83 + 2->text_84 + 3->pubk_85
          name_82 = arbitrary_server_splice.splice_server_as
          name_83 = arbitrary_server_splice.splice_server_s
          text_84 = arbitrary_server_splice.splice_server_N3
          pubk_85 = getPUBK[arbitrary_server_splice.splice_server_c]
        }}}}
        (enc_77).encryptionKey = getPRIVK[arbitrary_server_splice.splice_server_as]
      }}

      t3.sender = arbitrary_server_splice
      inds[((t3.data).components)] = 0+1+2
      let name_86  = (((t3.data).components))[0] | {
      let name_87  = (((t3.data).components))[1] | {
      let enc_88  = (((t3.data).components))[2] | {
        ((t3.data).components) = 0->name_86 + 1->name_87 + 2->enc_88
        name_86 = arbitrary_server_splice.splice_server_s
        name_87 = arbitrary_server_splice.splice_server_c
        inds[(enc_88).plaintext.components] = 0+1
        let name_91  = ((enc_88).plaintext.components)[0] | {
        let hash_92  = ((enc_88).plaintext.components)[1] | {
          (enc_88).plaintext.components = 0->name_91 + 1->hash_92
          name_91 = arbitrary_server_splice.splice_server_s
          (hash_92).hash_of = arbitrary_server_splice.splice_server_N2
        }}
        (enc_88).encryptionKey = getPUBK[arbitrary_server_splice.splice_server_c]
      }}}

    }}}}
  }
}
one sig skeleton_splice_0 {
  skeleton_splice_0_c : one name,
  skeleton_splice_0_s : one name,
  skeleton_splice_0_as : one name,
  skeleton_splice_0_N1 : one text,
  skeleton_splice_0_N2 : one text,
  skeleton_splice_0_N3 : one text,
  skeleton_splice_0_T : one text,
  skeleton_splice_0_L : one text
}
pred constrain_skeleton_splice_0 {
  some skeleton_client_0_strand_0 : splice_client | {
    skeleton_client_0_strand_0.splice_client_c = skeleton_splice_0.skeleton_splice_0_c
    skeleton_client_0_strand_0.splice_client_s = skeleton_splice_0.skeleton_splice_0_s
    skeleton_client_0_strand_0.splice_client_as = skeleton_splice_0.skeleton_splice_0_as
    skeleton_client_0_strand_0.splice_client_N1 = skeleton_splice_0.skeleton_splice_0_N1
    skeleton_client_0_strand_0.splice_client_N2 = skeleton_splice_0.skeleton_splice_0_N2
    skeleton_client_0_strand_0.splice_client_N3 = skeleton_splice_0.skeleton_splice_0_N3
    skeleton_client_0_strand_0.splice_client_T = skeleton_splice_0.skeleton_splice_0_T
    skeleton_client_0_strand_0.splice_client_L = skeleton_splice_0.skeleton_splice_0_L
  }
  some skeleton_authority_0_strand_1 : splice_authority | {
    skeleton_authority_0_strand_1.splice_authority_c = skeleton_splice_0.skeleton_splice_0_c
    skeleton_authority_0_strand_1.splice_authority_s = skeleton_splice_0.skeleton_splice_0_s
    skeleton_authority_0_strand_1.splice_authority_as = skeleton_splice_0.skeleton_splice_0_as
    skeleton_authority_0_strand_1.splice_authority_N1 = skeleton_splice_0.skeleton_splice_0_N1
    skeleton_authority_0_strand_1.splice_authority_N2 = skeleton_splice_0.skeleton_splice_0_N2
    skeleton_authority_0_strand_1.splice_authority_N3 = skeleton_splice_0.skeleton_splice_0_N3
    skeleton_authority_0_strand_1.splice_authority_T = skeleton_splice_0.skeleton_splice_0_T
    skeleton_authority_0_strand_1.splice_authority_L = skeleton_splice_0.skeleton_splice_0_L
  }
  some skeleton_server_0_strand_2 : splice_server | {
    skeleton_server_0_strand_2.splice_server_c = skeleton_splice_0.skeleton_splice_0_c
    skeleton_server_0_strand_2.splice_server_s = skeleton_splice_0.skeleton_splice_0_s
    skeleton_server_0_strand_2.splice_server_as = skeleton_splice_0.skeleton_splice_0_as
    skeleton_server_0_strand_2.splice_server_N1 = skeleton_splice_0.skeleton_splice_0_N1
    skeleton_server_0_strand_2.splice_server_N2 = skeleton_splice_0.skeleton_splice_0_N2
    skeleton_server_0_strand_2.splice_server_N3 = skeleton_splice_0.skeleton_splice_0_N3
    skeleton_server_0_strand_2.splice_server_T = skeleton_splice_0.skeleton_splice_0_T
    skeleton_server_0_strand_2.splice_server_L = skeleton_splice_0.skeleton_splice_0_L
  }
}
one sig skeleton_attack1_1 {
  skeleton_attack1_1_c : one name,
  skeleton_attack1_1_s : one name,
  skeleton_attack1_1_as : one name,
  skeleton_attack1_1_N1 : one text,
...
pred constrain_skeleton_attack1_1 {
  some skeleton_authority_1_strand_0 : splice_authority | {
    ...
    skeleton_authority_1_strand_0.splice_authority_N2 = skeleton_attack1_1.skeleton_attack1_1_N2
    skeleton_authority_1_strand_0.splice_authority_N3 = skeleton_attack1_1.skeleton_attack1_1_N3
    skeleton_authority_1_strand_0.splice_authority_T = skeleton_attack1_1.skeleton_attack1_1_T
  ...
  some skeleton_server_1_strand_1 : splice_server | {
    ...
    skeleton_server_1_strand_1.splice_server_N2 = skeleton_attack1_1.skeleton_attack1_1_N2
