...
sig hash_term_test_A extends strand {
  hash_term_test_A_n1 : one text
}
pred exec_hash_term_test_A {
  all arbitrary_A_hash_term_test : hash_term_test_A | {
    some t0 : Timeslot {
      some t1 : t0.(^next) {
        t0+t1 = sender.arbitrary_A_hash_term_test + receiver.arbitrary_A_hash_term_test
        t0.sender = arbitrary_A_hash_term_test
        inds[(t0.data)] = 0
        (t0.data)[0] = arbitrary_A_hash_term_test.hash_term_test_A_n1

        t1.receiver = arbitrary_A_hash_term_test
        inds[(t1.data)] = 0
        (t1.data)[0] in Hashed
        ((t1.data)[0]).hash_of = arbitrary_A_hash_term_test.hash_term_test_A_n1

      }
    }
  }
}
sig hash_term_test_B extends strand {
  hash_term_test_B_n1 : one text
}
pred exec_hash_term_test_B {
  all arbitrary_B_hash_term_test : hash_term_test_B | {
    some t0 : Timeslot {
      some t1 : t0.(^next) {
        t0+t1 = sender.arbitrary_B_hash_term_test + receiver.arbitrary_B_hash_term_test
        t0.receiver = arbitrary_B_hash_term_test
        inds[(t0.data)] = 0
        (t0.data)[0] = arbitrary_B_hash_term_test.hash_term_test_B_n1

        t1.sender = arbitrary_B_hash_term_test
        inds[(t1.data)] = 0
        (t1.data)[0] in Hashed
        ((t1.data)[0]).hash_of = arbitrary_B_hash_term_test.hash_term_test_B_n1

      }
    }
  }
}
one sig skeleton_hash_term_test_0 {
  skeleton_hash_term_test_0_n1 : one text,
  skeleton_hash_term_test_0_A : one hash_term_test_A,
  skeleton_hash_term_test_0_B : one hash_term_test_B
}
pred constrain_skeleton_hash_term_test_0_poss_run {
  some t_0 : Timeslot {
    some t_1 : t_0.(^next) {
      some t_2 : t_1.(^next) {
        some t_3 : t_2.(^next) {
          t_0.sender = skeleton_hash_term_test_0.skeleton_hash_term_test_0_A
          inds[t_0.data] = 0
          t_0.data[0] = skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1

          t_1.receiver = skeleton_hash_term_test_0.skeleton_hash_term_test_0_B
          inds[t_1.data] = 0
          t_1.data[0] = skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1

          t_2.receiver = skeleton_hash_term_test_0.skeleton_hash_term_test_0_A
          inds[t_2.data] = 0
          t_2.data[0] in Hashed
          (t_2.data[0]).hash_of = skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1

          t_3.sender = skeleton_hash_term_test_0.skeleton_hash_term_test_0_B
          inds[t_3.data] = 0
          t_3.data[0] in Hashed
          (t_3.data[0]).hash_of = skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1
...
pred constrain_skeleton_hash_term_test_0 {
  some skeleton_A_0_strand_0 : hash_term_test_A | {
    skeleton_A_0_strand_0.hash_term_test_A_n1 = skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1
  }
  one aStrand : strand | {
    originates[aStrand,skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1] or generates [aStrand,skeleton_hash_term_test_0.skeleton_hash_term_test_0_n1]
  }
  constrain_skeleton_hash_term_test_0_poss_run
}
