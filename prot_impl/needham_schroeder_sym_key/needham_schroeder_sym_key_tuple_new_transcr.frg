  ...
  all arbitrary_init_needham_schroeder_sym_key : needham_schroeder_sym_key_init | {
    ...
    some t4 : t3.(^next) {
      ...
      let cat_5  = (((t1.data)).plaintext.components)[0] | {
        ...
        inds[(cat_5.components)] = 0+1+2+3
        let text_6  = ((cat_5.components))[0] | {
        let name_7  = ((cat_5.components))[1] | {
        let skey_8  = ((cat_5.components))[2] | {
        let enc_9  = ((cat_5.components))[3] | {
          (cat_5.components) = 0->text_6 + 1->name_7 + 2->skey_8 + 3->enc_9
          ...
          let cat_11  = ((enc_9).plaintext.components)[0] | {
            ...
            inds[(cat_11.components)] = 0+1
            let skey_12  = ((cat_11.components))[0] | {
            let name_13  = ((cat_11.components))[1] | {
              (cat_11.components) = 0->skey_12 + 1->name_13
              skey_12 = arbitrary_init_needham_schroeder_sym_key.needham_schroeder_sym_key_init_Kab
      ...
      let cat_15  = (((t2.data)).plaintext.components)[0] | {
        ...
        inds[(cat_15.components)] = 0+1
        let skey_16  = ((cat_15.components))[0] | {
        let name_17  = ((cat_15.components))[1] | {
          (cat_15.components) = 0->skey_16 + 1->name_17
          skey_16 = arbitrary_init_needham_schroeder_sym_key.needham_schroeder_sym_key_init_Kab
      ...
      let text_19  = (((t3.data)).plaintext.components)[0] | {
        ((t3.data)).plaintext.components = 0->text_19
        text_19 = arbitrary_init_needham_schroeder_sym_key.needham_schroeder_sym_key_init_Nb
      }
      ...
      let hash_21  = (((t4.data)).plaintext.components)[0] | {
        ((t4.data)).plaintext.components = 0->hash_21
        (hash_21).hash_of = arbitrary_init_needham_schroeder_sym_key.needham_schroeder_sym_key_init_Nb
      }
...
pred exec_needham_schroeder_sym_key_server {
  all arbitrary_server_needham_schroeder_sym_key : needham_schroeder_sym_key_server | {
    ...
    some t1 : t0.(^next) {
      ...
      inds[((t0.data).components)] = 0+1+2
      let name_22  = (((t0.data).components))[0] | {
      let name_23  = (((t0.data).components))[1] | {
      let text_24  = (((t0.data).components))[2] | {
        ((t0.data).components) = 0->name_22 + 1->name_23 + 2->text_24
        name_22 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_a
        name_23 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_b
        text_24 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_Na
      }}}
      ...
      let cat_26  = (((t1.data)).plaintext.components)[0] | {
        ...
        let text_27  = ((cat_26.components))[0] | {
        let name_28  = ((cat_26.components))[1] | {
        let skey_29  = ((cat_26.components))[2] | {
        let enc_30  = ((cat_26.components))[3] | {
          (cat_26.components) = 0->text_27 + 1->name_28 + 2->skey_29 + 3->enc_30
          text_27 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_Na
          name_28 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_b
          ...
          let cat_32  = ((enc_30).plaintext.components)[0] | {
            ...
            inds[(cat_32.components)] = 0+1
            let skey_33  = ((cat_32.components))[0] | {
            let name_34  = ((cat_32.components))[1] | {
              (cat_32.components) = 0->skey_33 + 1->name_34
              skey_33 = arbitrary_server_needham_schroeder_sym_key.needham_schroeder_sym_key_server_Kab
  ...
  all arbitrary_resp_needham_schroeder_sym_key : needham_schroeder_sym_key_resp | {
    ...
    some t2 : t1.(^next) {
      ...
      let cat_36  = (((t0.data)).plaintext.components)[0] | {
        ...
        inds[(cat_36.components)] = 0+1
        let skey_37  = ((cat_36.components))[0] | {
        let name_38  = ((cat_36.components))[1] | {
          (cat_36.components) = 0->skey_37 + 1->name_38
          skey_37 = arbitrary_resp_needham_schroeder_sym_key.needham_schroeder_sym_key_resp_Kab
      ...
      inds[((t1.data)).plaintext.components] = 0
      let text_40  = (((t1.data)).plaintext.components)[0] | {
        ((t1.data)).plaintext.components = 0->text_40
        text_40 = arbitrary_resp_needham_schroeder_sym_key.needham_schroeder_sym_key_resp_Nb
      }
      ...
      inds[((t2.data)).plaintext.components] = 0
      let hash_42  = (((t2.data)).plaintext.components)[0] | {
        ((t2.data)).plaintext.components = 0->hash_42
        (hash_42).hash_of = arbitrary_resp_needham_schroeder_sym_key.needham_schroeder_sym_key_resp_Nb
      }
