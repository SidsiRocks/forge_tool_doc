...
sig nested_seq_test_A extends strand {
  nested_seq_test_A_a : one name,
  nested_seq_test_A_b : one name,
  nested_seq_test_A_n0 : one text,
  nested_seq_test_A_n1 : one text
}
pred exec_nested_seq_test_A {
  all arbitrary_A_nested_seq_test : nested_seq_test_A | {
    some t0 : Timeslot {
      some t1 : t0.(^next) {
        t0+t1 = sender.arbitrary_A_nested_seq_test + receiver.arbitrary_A_nested_seq_test
        t0.sender = arbitrary_A_nested_seq_test
        inds[(t0.data)] = 0
        some enc_2 : elems[(t0.data)] | {
          ...
          some enc_6 : elems[((((enc_2).plaintext)[0]).components)] | {
            ...
            ((((enc_2).plaintext)[0]).components)[0] = getPUBK[arbitrary_A_nested_seq_test.nested_seq_test_A_a]
            inds[((enc_6).plaintext)] = 0
            ((enc_6).plaintext)[0] in nonce
            ((enc_6).plaintext)[0] = arbitrary_A_nested_seq_test.nested_seq_test_A_n0
            ((enc_6).encryptionKey) = getPUBK[arbitrary_A_nested_seq_test.nested_seq_test_A_b]
          }
          ((enc_2).encryptionKey) = getPUBK[arbitrary_A_nested_seq_test.nested_seq_test_A_b]
        }

        t1.receiver = arbitrary_A_nested_seq_test
        inds[(t1.data)] = 0
        some enc_9 : elems[(t1.data)] | {
          (t1.data)[0] = enc_9
          learnt_term_by[getPRIVK[arbitrary_A_nested_seq_test.nested_seq_test_A_a],arbitrary_A_nested_seq_test.agent,t1]
          inds[((enc_9).plaintext)] = 0
          inds[((((enc_9).plaintext)[0]).components)] = 0+1
          ((((enc_9).plaintext)[0]).components)[0] = getPUBK[arbitrary_A_nested_seq_test.nested_seq_test_A_a]
          ((((enc_9).plaintext)[0]).components)[1] = arbitrary_A_nested_seq_test.nested_seq_test_A_n1
          ((enc_9).encryptionKey) = getPUBK[arbitrary_A_nested_seq_test.nested_seq_test_A_a]
        }
...
sig nested_seq_test_B extends strand {
  nested_seq_test_B_a : one name,
  nested_seq_test_B_b : one name,
  nested_seq_test_B_n0 : one text
}
pred exec_nested_seq_test_B {
  all arbitrary_B_nested_seq_test : nested_seq_test_B | {
    some t0 : Timeslot {
      some t1 : t0.(^next) {
        t0+t1 = sender.arbitrary_B_nested_seq_test + receiver.arbitrary_B_nested_seq_test
        t0.receiver = arbitrary_B_nested_seq_test
        inds[(t0.data)] = 0
        some enc_14 : elems[(t0.data)] | {
          (t0.data)[0] = enc_14
          learnt_term_by[getPRIVK[arbitrary_B_nested_seq_test.nested_seq_test_B_b],arbitrary_B_nested_seq_test.agent,t0]
          inds[((enc_14).plaintext)] = 0
          inds[((((enc_14).plaintext)[0]).components)] = 0+1
          some enc_18 : elems[((((enc_14).plaintext)[0]).components)] | {
            ((((enc_14).plaintext)[0]).components)[1] = enc_18
            ((((enc_14).plaintext)[0]).components)[0] = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_a]
            learnt_term_by[getPRIVK[arbitrary_B_nested_seq_test.nested_seq_test_B_b],arbitrary_B_nested_seq_test.agent,t0]
            inds[((enc_18).plaintext)] = 0
            ((enc_18).plaintext)[0] = arbitrary_B_nested_seq_test.nested_seq_test_B_n0
            ((enc_18).encryptionKey) = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_b]
          }
          ((enc_14).encryptionKey) = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_b]
        }

        t1.sender = arbitrary_B_nested_seq_test
        inds[(t1.data)] = 0
        some enc_21 : elems[(t1.data)] | {
          (t1.data)[0] = enc_21
          ...
          some enc_25 : elems[((((enc_21).plaintext)[0]).components)] | {
            ...
            ((((enc_21).plaintext)[0]).components)[0] = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_a]
            inds[((enc_25).plaintext)] = 0
            inds[((((enc_25).plaintext)[0]).components)] = 0+1
            some enc_29 : elems[((((enc_25).plaintext)[0]).components)] | {
              ((((enc_25).plaintext)[0]).components)[1] = enc_29
              ((((enc_25).plaintext)[0]).components)[0] = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_a]
              inds[((enc_29).plaintext)] = 0
              ((enc_29).plaintext)[0] in nonce
              ((enc_29).plaintext)[0] = arbitrary_B_nested_seq_test.nested_seq_test_B_n0
              ((enc_29).encryptionKey) = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_b]
            }
            ((enc_25).encryptionKey) = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_b]
          }
          ((enc_21).encryptionKey) = getPUBK[arbitrary_B_nested_seq_test.nested_seq_test_B_a]
        }
...
one sig skeleton_nested_seq_test_0 {
  skeleton_nested_seq_test_0_a : one name,
  skeleton_nested_seq_test_0_b : one name,
  skeleton_nested_seq_test_0_n0 : one text
}
pred constrain_skeleton_nested_seq_test_0 {
  some skeleton_A_0_strand_0 : nested_seq_test_A | {
    skeleton_A_0_strand_0.nested_seq_test_A_a = skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_a
    skeleton_A_0_strand_0.nested_seq_test_A_n0 = skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_n0
  }
  some skeleton_B_0_strand_1 : nested_seq_test_B | {
    skeleton_B_0_strand_1.nested_seq_test_B_a = skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_a
    skeleton_B_0_strand_1.nested_seq_test_B_b = skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_b
  }
  one aStrand : strand | {
    originates[aStrand,skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_n0] or generates [aStrand,skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_n0]
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_a]] or generates [aStrand,getPRIVK[skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_a]]
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[Attacker]] or generates [aStrand,getPRIVK[Attacker]]
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_b]] or generates [aStrand,getPRIVK[skeleton_nested_seq_test_0.skeleton_nested_seq_test_0_b]]
  }
}
