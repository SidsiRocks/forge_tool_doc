...
sig woo_and_lam_pi1_init extends strand {
  woo_and_lam_pi1_init_a : one name,
  woo_and_lam_pi1_init_b : one name,
  woo_and_lam_pi1_init_s : one name,
  woo_and_lam_pi1_init_Nb : one text
}
pred exec_woo_and_lam_pi1_init {
  all arbitrary_init_woo_and_lam_pi1 : woo_and_lam_pi1_init | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a,arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_s]] or generates [aStrand,getLTK[arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a,arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_s]]
    }
    arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a != arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_b
    arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a != arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_s
    arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_b != arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      t0+t1+t2 = sender.arbitrary_init_woo_and_lam_pi1 + receiver.arbitrary_init_woo_and_lam_pi1
      t0.sender = arbitrary_init_woo_and_lam_pi1
      (t0.data) = arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a

      t1.receiver = arbitrary_init_woo_and_lam_pi1
      (t1.data) = arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_Nb

      t2.sender = arbitrary_init_woo_and_lam_pi1
      ...
      let text_6  = (((t2.data)).plaintext.components)[2] | {
        ...
        name_4 = arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a
        name_5 = arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_b
        text_6 = arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_Nb
      }}}
      ((t2.data)).encryptionKey = getLTK[arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_a,arbitrary_init_woo_and_lam_pi1.woo_and_lam_pi1_init_s]

    }}}
  }
}
sig woo_and_lam_pi1_resp extends strand {
  woo_and_lam_pi1_resp_a : one name,
  woo_and_lam_pi1_resp_b : one name,
  woo_and_lam_pi1_resp_s : one name,
  woo_and_lam_pi1_resp_Nb : one text,
  woo_and_lam_pi1_resp_msg : one mesg
}
pred exec_woo_and_lam_pi1_resp {
  all arbitrary_resp_woo_and_lam_pi1 : woo_and_lam_pi1_resp | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b,arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s]] or generates [aStrand,getLTK[arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b,arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s]]
    }
    (generated_times.Timeslot).(arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_Nb) = arbitrary_resp_woo_and_lam_pi1.agent
    arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_a != arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b
    arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_a != arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s
    arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b != arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
    some t4 : t3.(^next) {
      ((arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_Nb)->t1) in (arbitrary_resp_woo_and_lam_pi1.agent).generated_times
      t0+t1+t2+t3+t4 = sender.arbitrary_resp_woo_and_lam_pi1 + receiver.arbitrary_resp_woo_and_lam_pi1
      t0.receiver = arbitrary_resp_woo_and_lam_pi1
      (t0.data) = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_a

      t1.sender = arbitrary_resp_woo_and_lam_pi1
      (t1.data) = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_Nb

      t2.receiver = arbitrary_resp_woo_and_lam_pi1
      (t2.data) = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_msg

      t3.sender = arbitrary_resp_woo_and_lam_pi1
      inds[((t3.data)).plaintext.components] = 0+1+2
      let name_10  = (((t3.data)).plaintext.components)[0] | {
      let name_11  = (((t3.data)).plaintext.components)[1] | {
      let mesg_12  = (((t3.data)).plaintext.components)[2] | {
        ((t3.data)).plaintext.components = 0->name_10 + 1->name_11 + 2->mesg_12
        name_10 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_a
        name_11 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b
        mesg_12 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_msg
      }}}
      ((t3.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b,arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s]

      t4.receiver = arbitrary_resp_woo_and_lam_pi1
      learnt_term_by[getLTK[arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b,arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s],arbitrary_resp_woo_and_lam_pi1.agent,t4]
      inds[((t4.data)).plaintext.components] = 0+1+2
      let name_16  = (((t4.data)).plaintext.components)[0] | {
      let name_17  = (((t4.data)).plaintext.components)[1] | {
      let text_18  = (((t4.data)).plaintext.components)[2] | {
        ((t4.data)).plaintext.components = 0->name_16 + 1->name_17 + 2->text_18
        name_16 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_a
        name_17 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b
        text_18 = arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_Nb
      }}}
      ((t4.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_b,arbitrary_resp_woo_and_lam_pi1.woo_and_lam_pi1_resp_s]

    }}}}}
  }
}
sig woo_and_lam_pi1_server extends strand {
  woo_and_lam_pi1_server_a : one name,
  woo_and_lam_pi1_server_b : one name,
  woo_and_lam_pi1_server_s : one name,
  woo_and_lam_pi1_server_Nb : one text
}
pred exec_woo_and_lam_pi1_server {
  all arbitrary_server_woo_and_lam_pi1 : woo_and_lam_pi1_server | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]]
    }
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]]
    }
    arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a != arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b
    arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a != arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s
    arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b != arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      t0+t1 = sender.arbitrary_server_woo_and_lam_pi1 + receiver.arbitrary_server_woo_and_lam_pi1
      t0.receiver = arbitrary_server_woo_and_lam_pi1
      learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s],arbitrary_server_woo_and_lam_pi1.agent,t0]
      inds[((t0.data)).plaintext.components] = 0+1+2
      let name_22  = (((t0.data)).plaintext.components)[0] | {
      let name_23  = (((t0.data)).plaintext.components)[1] | {
      let enc_24  = (((t0.data)).plaintext.components)[2] | {
        ((t0.data)).plaintext.components = 0->name_22 + 1->name_23 + 2->enc_24
        name_22 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a
        name_23 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b
        learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s],arbitrary_server_woo_and_lam_pi1.agent,t0]
        inds[(enc_24).plaintext.components] = 0+1+2
        let name_28  = ((enc_24).plaintext.components)[0] | {
        let name_29  = ((enc_24).plaintext.components)[1] | {
        let text_30  = ((enc_24).plaintext.components)[2] | {
          (enc_24).plaintext.components = 0->name_28 + 1->name_29 + 2->text_30
          name_28 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a
          name_29 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b
          text_30 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_Nb
        }}}
        (enc_24).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]
      }}}
      ((t0.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]

      t1.sender = arbitrary_server_woo_and_lam_pi1
      inds[((t1.data)).plaintext.components] = 0+1+2
      let name_34  = (((t1.data)).plaintext.components)[0] | {
      let name_35  = (((t1.data)).plaintext.components)[1] | {
      let text_36  = (((t1.data)).plaintext.components)[2] | {
        ((t1.data)).plaintext.components = 0->name_34 + 1->name_35 + 2->text_36
        name_34 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_a
        name_35 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b
        text_36 = arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_Nb
      }}}
      ((t1.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_b,arbitrary_server_woo_and_lam_pi1.woo_and_lam_pi1_server_s]

    }}
  }
}
one sig skeleton_woo_and_lam_pi1_0 {
  skeleton_woo_and_lam_pi1_0_a : one name,
  skeleton_woo_and_lam_pi1_0_b : one name,
  skeleton_woo_and_lam_pi1_0_s : one name,
  skeleton_woo_and_lam_pi1_0_Nb : one text,
  skeleton_woo_and_lam_pi1_0_init_strand : one woo_and_lam_pi1_init,
  skeleton_woo_and_lam_pi1_0_resp_strand : one woo_and_lam_pi1_resp,
  skeleton_woo_and_lam_pi1_0_server_strand : one woo_and_lam_pi1_server
}
pred constrain_skeleton_woo_and_lam_pi1_0_honest_run {
  some t_0 : Timeslot {
  some t_1 : t_0.(^next) {
    t_0.sender = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_init_strand
    (t_0.data) = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_a

    t_1.receiver = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_resp_strand
    (t_1.data) = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_a

  }}
}
pred constrain_skeleton_woo_and_lam_pi1_0 {
  some skeleton_init_0_strand_0 : woo_and_lam_pi1_init | {
    skeleton_init_0_strand_0.woo_and_lam_pi1_init_a = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_a
    skeleton_init_0_strand_0.woo_and_lam_pi1_init_b = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_b
    skeleton_init_0_strand_0.woo_and_lam_pi1_init_s = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_s
    skeleton_init_0_strand_0.woo_and_lam_pi1_init_Nb = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_Nb
  }
  some skeleton_resp_0_strand_1 : woo_and_lam_pi1_resp | {
    skeleton_resp_0_strand_1.woo_and_lam_pi1_resp_a = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_a
    skeleton_resp_0_strand_1.woo_and_lam_pi1_resp_b = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_b
    skeleton_resp_0_strand_1.woo_and_lam_pi1_resp_s = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_s
    skeleton_resp_0_strand_1.woo_and_lam_pi1_resp_Nb = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_Nb
  }
  some skeleton_server_0_strand_2 : woo_and_lam_pi1_server | {
    skeleton_server_0_strand_2.woo_and_lam_pi1_server_a = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_a
    skeleton_server_0_strand_2.woo_and_lam_pi1_server_b = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_b
    skeleton_server_0_strand_2.woo_and_lam_pi1_server_s = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_s
    skeleton_server_0_strand_2.woo_and_lam_pi1_server_Nb = skeleton_woo_and_lam_pi1_0.skeleton_woo_and_lam_pi1_0_Nb
  }
  constrain_skeleton_woo_and_lam_pi1_0_honest_run
}
inst honest_run_bounds {
  ...
  components in tuple -> (0+1+2) -> (Key + name + text + Ciphertext + tuple + Hashed)
  KeyPairs = `KeyPairs0
  ...
  woo_and_lam_pi1_init = `woo_and_lam_pi1_init0
  woo_and_lam_pi1_resp = `woo_and_lam_pi1_resp0
  woo_and_lam_pi1_server = `woo_and_lam_pi1_server0
  AttackerStrand = `AttackerStrand0
  strand = woo_and_lam_pi1_init + woo_and_lam_pi1_resp + woo_and_lam_pi1_server + AttackerStrand
}
