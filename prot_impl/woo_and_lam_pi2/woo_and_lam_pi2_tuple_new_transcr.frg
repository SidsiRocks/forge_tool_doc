...
sig woo_and_lam_pi2_init extends strand {
  woo_and_lam_pi2_init_a : one name,
  woo_and_lam_pi2_init_b : one name,
  woo_and_lam_pi2_init_s : one name,
  woo_and_lam_pi2_init_Nb : one text
}
pred exec_woo_and_lam_pi2_init {
  all arbitrary_init_woo_and_lam_pi2 : woo_and_lam_pi2_init | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a,arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_s]] or generates [aStrand,getLTK[arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a,arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_s]]
    }
    arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a != arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_b
    arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a != arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_s
    arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_b != arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      t0+t1+t2 = sender.arbitrary_init_woo_and_lam_pi2 + receiver.arbitrary_init_woo_and_lam_pi2
      t0.sender = arbitrary_init_woo_and_lam_pi2
      (t0.data) = arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a

      t1.receiver = arbitrary_init_woo_and_lam_pi2
      (t1.data) = arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_Nb

      t2.sender = arbitrary_init_woo_and_lam_pi2
      inds[((t2.data)).plaintext.components] = 0+1
      let name_3  = (((t2.data)).plaintext.components)[0] | {
      let text_4  = (((t2.data)).plaintext.components)[1] | {
        ((t2.data)).plaintext.components = 0->name_3 + 1->text_4
        name_3 = arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a
        text_4 = arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_Nb
      }}
      ((t2.data)).encryptionKey = getLTK[arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_a,arbitrary_init_woo_and_lam_pi2.woo_and_lam_pi2_init_s]

    }}}
  }
}
sig woo_and_lam_pi2_resp extends strand {
  woo_and_lam_pi2_resp_a : one name,
  woo_and_lam_pi2_resp_b : one name,
  woo_and_lam_pi2_resp_s : one name,
  woo_and_lam_pi2_resp_Nb : one text,
  woo_and_lam_pi2_resp_msg : one mesg
}
pred exec_woo_and_lam_pi2_resp {
  all arbitrary_resp_woo_and_lam_pi2 : woo_and_lam_pi2_resp | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b,arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s]] or generates [aStrand,getLTK[arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b,arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s]]
    }
    (generated_times.Timeslot).(arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_Nb) = arbitrary_resp_woo_and_lam_pi2.agent
    arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_a != arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b
    arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_a != arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s
    arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b != arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
    some t4 : t3.(^next) {
      ((arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_Nb)->t1) in (arbitrary_resp_woo_and_lam_pi2.agent).generated_times
      t0+t1+t2+t3+t4 = sender.arbitrary_resp_woo_and_lam_pi2 + receiver.arbitrary_resp_woo_and_lam_pi2
      t0.receiver = arbitrary_resp_woo_and_lam_pi2
      (t0.data) = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_a

      t1.sender = arbitrary_resp_woo_and_lam_pi2
      (t1.data) = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_Nb

      t2.receiver = arbitrary_resp_woo_and_lam_pi2
      (t2.data) = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_msg

      t3.sender = arbitrary_resp_woo_and_lam_pi2
      inds[((t3.data)).plaintext.components] = 0+1
      let name_7  = (((t3.data)).plaintext.components)[0] | {
      let mesg_8  = (((t3.data)).plaintext.components)[1] | {
        ((t3.data)).plaintext.components = 0->name_7 + 1->mesg_8
        name_7 = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_a
        mesg_8 = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_msg
      }}
      ((t3.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b,arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s]

      t4.receiver = arbitrary_resp_woo_and_lam_pi2
      learnt_term_by[getLTK[arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b,arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s],arbitrary_resp_woo_and_lam_pi2.agent,t4]
      inds[((t4.data)).plaintext.components] = 0+1
      let name_11  = (((t4.data)).plaintext.components)[0] | {
      let text_12  = (((t4.data)).plaintext.components)[1] | {
        ((t4.data)).plaintext.components = 0->name_11 + 1->text_12
        name_11 = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_a
        text_12 = arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_Nb
      }}
      ((t4.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_b,arbitrary_resp_woo_and_lam_pi2.woo_and_lam_pi2_resp_s]

    }}}}}
  }
}
sig woo_and_lam_pi2_server extends strand {
  woo_and_lam_pi2_server_a : one name,
  woo_and_lam_pi2_server_b : one name,
  woo_and_lam_pi2_server_s : one name,
  woo_and_lam_pi2_server_Nb : one text
}
pred exec_woo_and_lam_pi2_server {
  all arbitrary_server_woo_and_lam_pi2 : woo_and_lam_pi2_server | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]]
    }
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]]
    }
    arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a != arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b
    arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a != arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s
    arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b != arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      t0+t1 = sender.arbitrary_server_woo_and_lam_pi2 + receiver.arbitrary_server_woo_and_lam_pi2
      t0.receiver = arbitrary_server_woo_and_lam_pi2
      learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s],arbitrary_server_woo_and_lam_pi2.agent,t0]
      inds[((t0.data)).plaintext.components] = 0+1
      let name_15  = (((t0.data)).plaintext.components)[0] | {
      let enc_16  = (((t0.data)).plaintext.components)[1] | {
        ((t0.data)).plaintext.components = 0->name_15 + 1->enc_16
        name_15 = arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a
        learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s],arbitrary_server_woo_and_lam_pi2.agent,t0]
        inds[(enc_16).plaintext.components] = 0+1
        let name_19  = ((enc_16).plaintext.components)[0] | {
        let text_20  = ((enc_16).plaintext.components)[1] | {
          (enc_16).plaintext.components = 0->name_19 + 1->text_20
          name_19 = arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a
          text_20 = arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_Nb
        }}
        (enc_16).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]
      }}
      ((t0.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]

      t1.sender = arbitrary_server_woo_and_lam_pi2
      inds[((t1.data)).plaintext.components] = 0+1
      let name_23  = (((t1.data)).plaintext.components)[0] | {
      let text_24  = (((t1.data)).plaintext.components)[1] | {
        ((t1.data)).plaintext.components = 0->name_23 + 1->text_24
        name_23 = arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_a
        text_24 = arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_Nb
      }}
      ((t1.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_b,arbitrary_server_woo_and_lam_pi2.woo_and_lam_pi2_server_s]

    }}
  }
}
one sig skeleton_woo_and_lam_pi2_0 {
  skeleton_woo_and_lam_pi2_0_a : one name,
  skeleton_woo_and_lam_pi2_0_b : one name,
  skeleton_woo_and_lam_pi2_0_s : one name,
  skeleton_woo_and_lam_pi2_0_Nb : one text,
  skeleton_woo_and_lam_pi2_0_init_strand : one woo_and_lam_pi2_init,
  skeleton_woo_and_lam_pi2_0_resp_strand : one woo_and_lam_pi2_resp,
  skeleton_woo_and_lam_pi2_0_server_strand : one woo_and_lam_pi2_server
}
pred constrain_skeleton_woo_and_lam_pi2_0_honest_run {
  some t_0 : Timeslot {
  some t_1 : t_0.(^next) {
    t_0.sender = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_init_strand
    (t_0.data) = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_a

    t_1.receiver = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_resp_strand
    (t_1.data) = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_a

  }}
}
pred constrain_skeleton_woo_and_lam_pi2_0 {
  some skeleton_init_0_strand_0 : woo_and_lam_pi2_init | {
    skeleton_init_0_strand_0.woo_and_lam_pi2_init_a = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_a
    skeleton_init_0_strand_0.woo_and_lam_pi2_init_b = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_b
    skeleton_init_0_strand_0.woo_and_lam_pi2_init_s = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_s
    skeleton_init_0_strand_0.woo_and_lam_pi2_init_Nb = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_Nb
  }
  some skeleton_resp_0_strand_1 : woo_and_lam_pi2_resp | {
    skeleton_resp_0_strand_1.woo_and_lam_pi2_resp_a = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_a
    skeleton_resp_0_strand_1.woo_and_lam_pi2_resp_b = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_b
    skeleton_resp_0_strand_1.woo_and_lam_pi2_resp_s = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_s
    skeleton_resp_0_strand_1.woo_and_lam_pi2_resp_Nb = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_Nb
  }
  some skeleton_server_0_strand_2 : woo_and_lam_pi2_server | {
    skeleton_server_0_strand_2.woo_and_lam_pi2_server_a = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_a
    skeleton_server_0_strand_2.woo_and_lam_pi2_server_b = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_b
    skeleton_server_0_strand_2.woo_and_lam_pi2_server_s = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_s
    skeleton_server_0_strand_2.woo_and_lam_pi2_server_Nb = skeleton_woo_and_lam_pi2_0.skeleton_woo_and_lam_pi2_0_Nb
  }
  constrain_skeleton_woo_and_lam_pi2_0_honest_run
}
inst honest_run_bounds {
  ...
  woo_and_lam_pi2_init = `woo_and_lam_pi2_init0
  woo_and_lam_pi2_resp = `woo_and_lam_pi2_resp0
  woo_and_lam_pi2_server = `woo_and_lam_pi2_server0
  AttackerStrand = `AttackerStrand0
  strand = woo_and_lam_pi2_init + woo_and_lam_pi2_resp + woo_and_lam_pi2_server + AttackerStrand
}
