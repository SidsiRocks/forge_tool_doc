...
pred exec_enc_term_A {
  all arbitrary_A_enc_term : enc_term_A | {
    some t0,t1 : Timeslot | {
      t1 in t0.(^next)
      t0+t1 = sender.arbitrary_A_enc_term + receiver.arbitrary_A_enc_term
      t0.sender = arbitrary_A_enc_term
      inds[(t0.data)] = 0
      some atom_1 : elems[(t0.data)] | {
        (t0.data)[0] = atom_1
        inds[(atom_1).plaintext] = 0+1
        some atom_2,atom_3 : elems[(atom_1).plaintext] | {
          (atom_1).plaintext[0] = atom_2
          (atom_1).plaintext[1] = atom_3
          atom_2 = arbitrary_A_enc_term.enc_term_A_n1
          atom_3 = arbitrary_A_enc_term.enc_term_A_n2
        }
        (atom_1).encryptionKey = getPUBK[arbitrary_A_enc_term.enc_term_A_a]
      }
      
      t1.receiver = arbitrary_A_enc_term
      inds[(t1.data)] = 0
      some atom_4 : elems[(t1.data)] | {
        (t1.data)[0] = atom_4
        inds[(atom_4).plaintext] = 0+1
        some atom_5,atom_6 : elems[(atom_4).plaintext] | {
          (atom_4).plaintext[0] = atom_5
          (atom_4).plaintext[1] = atom_6
          atom_5 = arbitrary_A_enc_term.enc_term_A_n3
          atom_6 = arbitrary_A_enc_term.enc_term_A_n4
        }
        (atom_4).encryptionKey = getPUBK[arbitrary_A_enc_term.enc_term_A_b]
      }
...
pred exec_enc_term_B {
  all arbitrary_B_enc_term : enc_term_B | {
    some t0,t1 : Timeslot | {
      t1 in t0.(^next)
      t0+t1 = sender.arbitrary_B_enc_term + receiver.arbitrary_B_enc_term
      t0.receiver = arbitrary_B_enc_term
      inds[(t0.data)] = 0
      some atom_7 : elems[(t0.data)] | {
        (t0.data)[0] = atom_7
        inds[(atom_7).plaintext] = 0+1
        some atom_8,atom_9 : elems[(atom_7).plaintext] | {
          (atom_7).plaintext[0] = atom_8
          (atom_7).plaintext[1] = atom_9
          atom_8 = arbitrary_B_enc_term.enc_term_B_n1
          atom_9 = arbitrary_B_enc_term.enc_term_B_n2
        }
        (atom_7).encryptionKey = getPUBK[arbitrary_B_enc_term.enc_term_B_a]
      }
      
      t1.sender = arbitrary_B_enc_term
      inds[(t1.data)] = 0
      some atom_10 : elems[(t1.data)] | {
        ...
        some atom_11,atom_12 : elems[(atom_10).plaintext] | {
          ...
          atom_11 = arbitrary_B_enc_term.enc_term_B_n3
          atom_12 = arbitrary_B_enc_term.enc_term_B_n4
        }
        (atom_10).encryptionKey = getPUBK[arbitrary_B_enc_term.enc_term_B_b]
      }
...
pred constrain_skeleton_enc_term_0 {
  some skeleton_A_0_strand_0 : enc_term_A | {
    skeleton_A_0_strand_0.enc_term_A_a = skelton_enc_term_0.skelton_enc_term_0_a
    skeleton_A_0_strand_0.enc_term_A_b = skelton_enc_term_0.skelton_enc_term_0_b
    skeleton_A_0_strand_0.enc_term_A_n1 = skelton_enc_term_0.skelton_enc_term_0_n1
    skeleton_A_0_strand_0.enc_term_A_n2 = skelton_enc_term_0.skelton_enc_term_0_n2
    skeleton_A_0_strand_0.enc_term_A_n3 = skelton_enc_term_0.skelton_enc_term_0_n3
    skeleton_A_0_strand_0.enc_term_A_n4 = skelton_enc_term_0.skelton_enc_term_0_n4
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[skelton_enc_term_0.skelton_enc_term_0_a]] or generates [aStrand,getPRIVK[skelton_enc_term_0.skelton_enc_term_0_a]]
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[skelton_enc_term_0.skelton_enc_term_0_b]] or generates [aStrand,getPRIVK[skelton_enc_term_0.skelton_enc_term_0_b]]
  }
}
