...
pred exec_reorder_terms_A {
  all arbitrary_A_reorder_terms : reorder_terms_A | {
    some t0,t1 : Timeslot | {
      t1 in t0.(^next)
      t0+t1 = sender.arbitrary_A_reorder_terms + receiver.arbitrary_A_reorder_terms
      t0.sender = arbitrary_A_reorder_terms
      inds[(t0.data)] = 0+1
      some sub_term_0,sub_term_1 : elems[(t0.data)] | {
        (t0.data)[0] = sub_term_0
        (t0.data)[1] = sub_term_1
        sub_term_0 = arbitrary_A_reorder_terms.reorder_terms_A_n1
        sub_term_1 = arbitrary_A_reorder_terms.reorder_terms_A_n2
      }
      
      t1.receiver = arbitrary_A_reorder_terms
      inds[(t1.data)] = 0+1
      some sub_term_0,sub_term_1 : elems[(t1.data)] | {
        (t1.data)[0] = sub_term_0
        (t1.data)[1] = sub_term_1
        sub_term_0 = arbitrary_A_reorder_terms.reorder_terms_A_n2
        sub_term_1 = arbitrary_A_reorder_terms.reorder_terms_A_n1
      }
...
pred exec_reorder_terms_B {
  all arbitrary_B_reorder_terms : reorder_terms_B | {
    some t0,t1 : Timeslot | {
      t1 in t0.(^next)
      t0+t1 = sender.arbitrary_B_reorder_terms + receiver.arbitrary_B_reorder_terms
      t0.receiver = arbitrary_B_reorder_terms
      inds[(t0.data)] = 0+1
      some sub_term_0,sub_term_1 : elems[(t0.data)] | {
        (t0.data)[0] = sub_term_0
        (t0.data)[1] = sub_term_1
        sub_term_0 = arbitrary_B_reorder_terms.reorder_terms_B_n2
        sub_term_1 = arbitrary_B_reorder_terms.reorder_terms_B_n1
      }
      
      t1.sender = arbitrary_B_reorder_terms
      inds[(t1.data)] = 0+1
      some sub_term_0,sub_term_1 : elems[(t1.data)] | {
        (t1.data)[0] = sub_term_0
        (t1.data)[1] = sub_term_1
