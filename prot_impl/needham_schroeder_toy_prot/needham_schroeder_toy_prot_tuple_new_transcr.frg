...
sig needham_schroeder_toy_prot_init extends strand {
  needham_schroeder_toy_prot_init_a : one name,
  needham_schroeder_toy_prot_init_b : one name,
  needham_schroeder_toy_prot_init_n1 : one text
}
pred exec_needham_schroeder_toy_prot_init {
  all arbitrary_init_needham_schroeder_toy_prot : needham_schroeder_toy_prot_init | {
    no aStrand : strand | {
      originates[aStrand,getPRIVK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a]] or generates [aStrand,getPRIVK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a]]
    }
    (generated_times.Timeslot).(arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_n1) = arbitrary_init_needham_schroeder_toy_prot.agent
    arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a != arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_b
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      ((arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_n1)->t0) in (arbitrary_init_needham_schroeder_toy_prot.agent).generated_times
      t0+t1 = sender.arbitrary_init_needham_schroeder_toy_prot + receiver.arbitrary_init_needham_schroeder_toy_prot
      t0.sender = arbitrary_init_needham_schroeder_toy_prot
      inds[((t0.data).components)] = 0+1
      let pubk_1  = (((t0.data).components))[0] | {
      let enc_2  = (((t0.data).components))[1] | {
        ((t0.data).components) = 0->pubk_1 + 1->enc_2
        pubk_1 = getPUBK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a]
        inds[(enc_2).plaintext.components] = 0
        let text_4  = ((enc_2).plaintext.components)[0] | {
          (enc_2).plaintext.components = 0->text_4
          text_4 = arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_n1
        }
        (enc_2).encryptionKey = getPUBK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_b]
      }}

      t1.receiver = arbitrary_init_needham_schroeder_toy_prot
      learnt_term_by[getPRIVK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a],arbitrary_init_needham_schroeder_toy_prot.agent,t1]
      inds[((t1.data)).plaintext.components] = 0
      let text_6  = (((t1.data)).plaintext.components)[0] | {
        ((t1.data)).plaintext.components = 0->text_6
        text_6 = arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_n1
      }
      ((t1.data)).encryptionKey = getPUBK[arbitrary_init_needham_schroeder_toy_prot.needham_schroeder_toy_prot_init_a]

    }}
  }
}
sig needham_schroeder_toy_prot_resp extends strand {
  needham_schroeder_toy_prot_resp_a : one name,
  needham_schroeder_toy_prot_resp_b : one name,
  needham_schroeder_toy_prot_resp_n1 : one text
}
pred exec_needham_schroeder_toy_prot_resp {
  all arbitrary_resp_needham_schroeder_toy_prot : needham_schroeder_toy_prot_resp | {
    no aStrand : strand | {
      originates[aStrand,getPRIVK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_b]] or generates [aStrand,getPRIVK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_b]]
    }
    arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_a != arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_b
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      t0+t1 = sender.arbitrary_resp_needham_schroeder_toy_prot + receiver.arbitrary_resp_needham_schroeder_toy_prot
      t0.receiver = arbitrary_resp_needham_schroeder_toy_prot
      inds[((t0.data).components)] = 0+1
      let pubk_7  = (((t0.data).components))[0] | {
      let enc_8  = (((t0.data).components))[1] | {
        ((t0.data).components) = 0->pubk_7 + 1->enc_8
        pubk_7 = getPUBK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_a]
        learnt_term_by[getPRIVK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_b],arbitrary_resp_needham_schroeder_toy_prot.agent,t0]
        inds[(enc_8).plaintext.components] = 0
        let text_10  = ((enc_8).plaintext.components)[0] | {
          (enc_8).plaintext.components = 0->text_10
          text_10 = arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_n1
        }
        (enc_8).encryptionKey = getPUBK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_b]
      }}

      t1.sender = arbitrary_resp_needham_schroeder_toy_prot
      inds[((t1.data)).plaintext.components] = 0
      let text_12  = (((t1.data)).plaintext.components)[0] | {
        ((t1.data)).plaintext.components = 0->text_12
        text_12 = arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_n1
      }
      ((t1.data)).encryptionKey = getPUBK[arbitrary_resp_needham_schroeder_toy_prot.needham_schroeder_toy_prot_resp_a]

    }}
  }
}
one sig skeleton_needham_schroeder_toy_prot_0 {
  skeleton_needham_schroeder_toy_prot_0_a : one name,
  skeleton_needham_schroeder_toy_prot_0_b : one name,
  skeleton_needham_schroeder_toy_prot_0_n1 : one text
}
pred constrain_skeleton_needham_schroeder_toy_prot_0 {
  some skeleton_init_0_strand_0 : needham_schroeder_toy_prot_init | {
    skeleton_init_0_strand_0.needham_schroeder_toy_prot_init_a = skeleton_needham_schroeder_toy_prot_0.skeleton_needham_schroeder_toy_prot_0_a
    skeleton_init_0_strand_0.needham_schroeder_toy_prot_init_b = skeleton_needham_schroeder_toy_prot_0.skeleton_needham_schroeder_toy_prot_0_b
    skeleton_init_0_strand_0.needham_schroeder_toy_prot_init_n1 = skeleton_needham_schroeder_toy_prot_0.skeleton_needham_schroeder_toy_prot_0_n1
  }
}
inst alt_single_session {
  ...
  needham_schroeder_toy_prot_init = `needham_schroeder_toy_prot_init0
  needham_schroeder_toy_prot_resp = `needham_schroeder_toy_prot_resp0
  AttackerStrand = `AttackerStrand0
  strand = needham_schroeder_toy_prot_init + needham_schroeder_toy_prot_resp + AttackerStrand
}
inst alt_double_session {
  ...
  generated_times in name -> (Key + text) -> Timeslot
  hash_of in Hashed -> text
  needham_schroeder_toy_prot_init = `needham_schroeder_toy_prot_init0 + `needham_schroeder_toy_prot_init1
  needham_schroeder_toy_prot_resp = `needham_schroeder_toy_prot_resp0 + `needham_schroeder_toy_prot_resp1
  AttackerStrand = `AttackerStrand0
  strand = needham_schroeder_toy_prot_init + needham_schroeder_toy_prot_resp + AttackerStrand
}
