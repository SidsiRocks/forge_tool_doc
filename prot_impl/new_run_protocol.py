...
if __name__ == "__main__":
    new_python_transcribe_main = path_rel_to_script( "../cspa_expanding/python_transcriber/main_seq_text.py")
    ...
    destination_forge_file_path = os.path.join(args.folder_path,f"{base_prot_name}_new_transcr_seq_text.frg")
