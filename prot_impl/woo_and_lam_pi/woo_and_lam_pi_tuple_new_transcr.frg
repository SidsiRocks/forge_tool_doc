...
sig woo_and_lam_pi_init extends strand {
  woo_and_lam_pi_init_a : one name,
  woo_and_lam_pi_init_b : one name,
  woo_and_lam_pi_init_s : one name,
  woo_and_lam_pi_init_Nb : one text
}
pred exec_woo_and_lam_pi_init {
  all arbitrary_init_woo_and_lam_pi : woo_and_lam_pi_init | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a,arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_s]] or generates [aStrand,getLTK[arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a,arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_s]]
    }
    arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a != arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_b
    arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a != arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_s
    arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_b != arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      t0+t1+t2 = sender.arbitrary_init_woo_and_lam_pi + receiver.arbitrary_init_woo_and_lam_pi
      t0.sender = arbitrary_init_woo_and_lam_pi
      (t0.data) = arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a

      t1.receiver = arbitrary_init_woo_and_lam_pi
      (t1.data) = arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_Nb

      t2.sender = arbitrary_init_woo_and_lam_pi
      inds[((t2.data)).plaintext.components] = 0
      let text_2  = (((t2.data)).plaintext.components)[0] | {
        ((t2.data)).plaintext.components = 0->text_2
        text_2 = arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_Nb
      }
      ((t2.data)).encryptionKey = getLTK[arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_a,arbitrary_init_woo_and_lam_pi.woo_and_lam_pi_init_s]

    }}}
  }
}
sig woo_and_lam_pi_resp extends strand {
  woo_and_lam_pi_resp_a : one name,
  woo_and_lam_pi_resp_b : one name,
  woo_and_lam_pi_resp_s : one name,
  woo_and_lam_pi_resp_Nb : one text,
  woo_and_lam_pi_resp_msg : one mesg
}
pred exec_woo_and_lam_pi_resp {
  all arbitrary_resp_woo_and_lam_pi : woo_and_lam_pi_resp | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b,arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s]] or generates [aStrand,getLTK[arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b,arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s]]
    }
    (generated_times.Timeslot).(arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_Nb) = arbitrary_resp_woo_and_lam_pi.agent
    arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_a != arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b
    arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_a != arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s
    arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b != arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
    some t4 : t3.(^next) {
      ((arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_Nb)->t1) in (arbitrary_resp_woo_and_lam_pi.agent).generated_times
      t0+t1+t2+t3+t4 = sender.arbitrary_resp_woo_and_lam_pi + receiver.arbitrary_resp_woo_and_lam_pi
      t0.receiver = arbitrary_resp_woo_and_lam_pi
      (t0.data) = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_a

      t1.sender = arbitrary_resp_woo_and_lam_pi
      (t1.data) = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_Nb

      t2.receiver = arbitrary_resp_woo_and_lam_pi
      (t2.data) = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_msg

      t3.sender = arbitrary_resp_woo_and_lam_pi
      ...
      let mesg_6  = (((t3.data)).plaintext.components)[1] | {
        ...
        name_5 = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_a
        mesg_6 = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_msg
      }}
      ((t3.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b,arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s]

      t4.receiver = arbitrary_resp_woo_and_lam_pi
      learnt_term_by[getLTK[arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b,arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s],arbitrary_resp_woo_and_lam_pi.agent,t4]
      inds[((t4.data)).plaintext.components] = 0
      let text_8  = (((t4.data)).plaintext.components)[0] | {
        ((t4.data)).plaintext.components = 0->text_8
        text_8 = arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_Nb
      }
      ((t4.data)).encryptionKey = getLTK[arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_b,arbitrary_resp_woo_and_lam_pi.woo_and_lam_pi_resp_s]

    }}}}}
  }
}
sig woo_and_lam_pi_server extends strand {
  woo_and_lam_pi_server_a : one name,
  woo_and_lam_pi_server_b : one name,
  woo_and_lam_pi_server_s : one name,
  woo_and_lam_pi_server_Nb : one text
}
pred exec_woo_and_lam_pi_server {
  all arbitrary_server_woo_and_lam_pi : woo_and_lam_pi_server | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]]
    }
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]] or generates [aStrand,getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]]
    }
    arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a != arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b
    arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a != arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s
    arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b != arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      t0+t1 = sender.arbitrary_server_woo_and_lam_pi + receiver.arbitrary_server_woo_and_lam_pi
      t0.receiver = arbitrary_server_woo_and_lam_pi
      learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s],arbitrary_server_woo_and_lam_pi.agent,t0]
      inds[((t0.data)).plaintext.components] = 0+1
      let name_11  = (((t0.data)).plaintext.components)[0] | {
      let enc_12  = (((t0.data)).plaintext.components)[1] | {
        ((t0.data)).plaintext.components = 0->name_11 + 1->enc_12
        name_11 = arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a
        learnt_term_by[getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s],arbitrary_server_woo_and_lam_pi.agent,t0]
        inds[(enc_12).plaintext.components] = 0
        let text_14  = ((enc_12).plaintext.components)[0] | {
          (enc_12).plaintext.components = 0->text_14
          text_14 = arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_Nb
        }
        (enc_12).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_a,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]
      }}
      ((t0.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]

      t1.sender = arbitrary_server_woo_and_lam_pi
      inds[((t1.data)).plaintext.components] = 0
      let text_16  = (((t1.data)).plaintext.components)[0] | {
        ((t1.data)).plaintext.components = 0->text_16
        text_16 = arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_Nb
      }
      ((t1.data)).encryptionKey = getLTK[arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_b,arbitrary_server_woo_and_lam_pi.woo_and_lam_pi_server_s]

    }}
  }
}
one sig skeleton_woo_and_lam_pi_0 {
  skeleton_woo_and_lam_pi_0_a : one name,
  skeleton_woo_and_lam_pi_0_b : one name,
  skeleton_woo_and_lam_pi_0_s : one name,
  skeleton_woo_and_lam_pi_0_Nb : one text
}
pred constrain_skeleton_woo_and_lam_pi_0 {
  some skeleton_init_0_strand_0 : woo_and_lam_pi_init | {
    skeleton_init_0_strand_0.woo_and_lam_pi_init_a = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_a
    skeleton_init_0_strand_0.woo_and_lam_pi_init_b = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_b
    skeleton_init_0_strand_0.woo_and_lam_pi_init_s = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_s
    skeleton_init_0_strand_0.woo_and_lam_pi_init_Nb = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_Nb
  }
  some skeleton_resp_0_strand_1 : woo_and_lam_pi_resp | {
    skeleton_resp_0_strand_1.woo_and_lam_pi_resp_a = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_a
    skeleton_resp_0_strand_1.woo_and_lam_pi_resp_b = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_b
    skeleton_resp_0_strand_1.woo_and_lam_pi_resp_s = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_s
    skeleton_resp_0_strand_1.woo_and_lam_pi_resp_Nb = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_Nb
  }
  some skeleton_server_0_strand_2 : woo_and_lam_pi_server | {
    skeleton_server_0_strand_2.woo_and_lam_pi_server_a = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_a
    skeleton_server_0_strand_2.woo_and_lam_pi_server_b = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_b
    skeleton_server_0_strand_2.woo_and_lam_pi_server_s = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_s
    skeleton_server_0_strand_2.woo_and_lam_pi_server_Nb = skeleton_woo_and_lam_pi_0.skeleton_woo_and_lam_pi_0_Nb
  }
}
inst honest_run_bounds {
  ...
  woo_and_lam_pi_init = `woo_and_lam_pi_init0
  woo_and_lam_pi_resp = `woo_and_lam_pi_resp0
  woo_and_lam_pi_server = `woo_and_lam_pi_server0
  AttackerStrand = `AttackerStrand0
  strand = woo_and_lam_pi_init + woo_and_lam_pi_resp + woo_and_lam_pi_server + AttackerStrand
}
