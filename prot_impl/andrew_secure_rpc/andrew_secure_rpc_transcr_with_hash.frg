        ...
        some t2 : t1.(^next) {
          some t3 : t2.(^next) {
            ...
            some enc_1 : elems[(t0.data)] | {
              (t0.data)[1] = enc_1
              (t0.data)[0] = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_a
              inds[(enc_1).plaintext] = 0
              (enc_1).plaintext[0] = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_na
              (enc_1).encryptionKey = getLTK[arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_a,arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_b]
            }

            t1.receiver = arbitrary_A_andrew_secure_rpc
            inds[(t1.data)] = 0
            some enc_4 : elems[(t1.data)] | {
              (t1.data)[0] = enc_4
              ...
              inds[(enc_4).plaintext] = 0+1
              (enc_4).plaintext[0] in Hashed
              ((enc_4).plaintext[0]).hash_of = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_na
              (enc_4).plaintext[1] = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_nb
              (enc_4).encryptionKey = getLTK[arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_a,arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_b]
            }

            t2.sender = arbitrary_A_andrew_secure_rpc
            inds[(t2.data)] = 0
            some enc_8 : elems[(t2.data)] | {
              (t2.data)[0] = enc_8
              inds[(enc_8).plaintext] = 0
              (enc_8).plaintext[0] in Hashed
              ((enc_8).plaintext[0]).hash_of = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_nb
              (enc_8).encryptionKey = getLTK[arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_a,arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_b]
            }

            t3.receiver = arbitrary_A_andrew_secure_rpc
            inds[(t3.data)] = 0
            some enc_11 : elems[(t3.data)] | {
              (t3.data)[0] = enc_11
              ...
              (enc_11).plaintext[0] = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_kab_
              (enc_11).plaintext[1] = arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_nb_
              (enc_11).encryptionKey = getLTK[arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_a,arbitrary_A_andrew_secure_rpc.andrew_secure_rpc_A_b]
            }
        ...
        some t2 : t1.(^next) {
          some t3 : t2.(^next) {
            ...
            some enc_14 : elems[(t0.data)] | {
              (t0.data)[1] = enc_14
              (t0.data)[0] = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_a
              ...
              (enc_14).plaintext[0] = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_na
              (enc_14).encryptionKey = getLTK[arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_a,arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_b]
            }
            ...
            some enc_17 : elems[(t1.data)] | {
              (t1.data)[0] = enc_17
              inds[(enc_17).plaintext] = 0+1
              (enc_17).plaintext[0] in Hashed
              ((enc_17).plaintext[0]).hash_of = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_na
              (enc_17).plaintext[1] = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_nb
              (enc_17).encryptionKey = getLTK[arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_a,arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_b]
            }

            t2.receiver = arbitrary_B_andrew_secure_rpc
            inds[(t2.data)] = 0
            some enc_21 : elems[(t2.data)] | {
              (t2.data)[0] = enc_21
              ...
              (enc_21).plaintext[0] in Hashed
              ((enc_21).plaintext[0]).hash_of = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_nb
              (enc_21).encryptionKey = getLTK[arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_a,arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_b]
            }

            t3.sender = arbitrary_B_andrew_secure_rpc
            inds[(t3.data)] = 0
            some enc_24 : elems[(t3.data)] | {
              (t3.data)[0] = enc_24
              inds[(enc_24).plaintext] = 0+1
              (enc_24).plaintext[0] = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_kab_
              (enc_24).plaintext[1] = arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_nb_
              (enc_24).encryptionKey = getLTK[arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_a,arbitrary_B_andrew_secure_rpc.andrew_secure_rpc_B_b]
            }
