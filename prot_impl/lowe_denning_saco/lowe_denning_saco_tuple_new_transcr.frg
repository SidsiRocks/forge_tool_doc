...
sig lowe_denning_saco_init extends strand {
...
pred exec_lowe_denning_saco_init {
  all arbitrary_init_lowe_denning_saco : lowe_denning_saco_init | {
    ...
    arbitrary_init_lowe_denning_saco.lowe_denning_saco_init_b != arbitrary_init_lowe_denning_saco.lowe_denning_saco_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
    some t3 : t2.(^next) {
    some t4 : t3.(^next) {
      t0+t1+t2+t3+t4 = sender.arbitrary_init_lowe_denning_saco + receiver.arbitrary_init_lowe_denning_saco
      t0.sender = arbitrary_init_lowe_denning_saco
      ...
      let name_2  = (((t0.data).components))[1] | {
        ...
        name_1 = arbitrary_init_lowe_denning_saco.lowe_denning_saco_init_a
        name_2 = arbitrary_init_lowe_denning_saco.lowe_denning_saco_init_b
      }}
...
sig lowe_denning_saco_server extends strand {
...
pred exec_lowe_denning_saco_server {
  all arbitrary_server_lowe_denning_saco : lowe_denning_saco_server | {
    ...
    arbitrary_server_lowe_denning_saco.lowe_denning_saco_server_a != arbitrary_server_lowe_denning_saco.lowe_denning_saco_server_b
    arbitrary_server_lowe_denning_saco.lowe_denning_saco_server_a != arbitrary_server_lowe_denning_saco.lowe_denning_saco_server_s
...
sig lowe_denning_saco_resp extends strand {
...
one sig skeleton_lowe_denning_saco_0 {
...
pred constrain_skeleton_lowe_denning_saco_0 {
  ...
  some skeleton_server_0_strand_1 : lowe_denning_saco_server | {
...
inst honest_run_bounds {
  ...
  lowe_denning_saco_init = `lowe_denning_saco_init0
  lowe_denning_saco_server = `lowe_denning_saco_server0
  lowe_denning_saco_resp = `lowe_denning_saco_resp0
  AttackerStrand = `AttackerStrand0
  strand = lowe_denning_saco_init + lowe_denning_saco_server + lowe_denning_saco_resp + AttackerStrand
}
