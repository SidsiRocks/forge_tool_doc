...
sig yahalom_paulson_init extends strand {
  yahalom_paulson_init_a : one name,
  yahalom_paulson_init_b : one name,
  yahalom_paulson_init_s : one name,
  yahalom_paulson_init_Na : one text,
  yahalom_paulson_init_Nb : one text,
  yahalom_paulson_init_Kab : one skey,
  yahalom_paulson_init_msg : one mesg
}
pred exec_yahalom_paulson_init {
  all arbitrary_init_yahalom_paulson : yahalom_paulson_init | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_init_yahalom_paulson.yahalom_paulson_init_a,arbitrary_init_yahalom_paulson.yahalom_paulson_init_s]] or generates [aStrand,getLTK[arbitrary_init_yahalom_paulson.yahalom_paulson_init_a,arbitrary_init_yahalom_paulson.yahalom_paulson_init_s]]
    }
    (generated_times.Timeslot).(arbitrary_init_yahalom_paulson.yahalom_paulson_init_Na) = arbitrary_init_yahalom_paulson.agent
    arbitrary_init_yahalom_paulson.yahalom_paulson_init_a != arbitrary_init_yahalom_paulson.yahalom_paulson_init_b
    arbitrary_init_yahalom_paulson.yahalom_paulson_init_a != arbitrary_init_yahalom_paulson.yahalom_paulson_init_s
    arbitrary_init_yahalom_paulson.yahalom_paulson_init_b != arbitrary_init_yahalom_paulson.yahalom_paulson_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      ((arbitrary_init_yahalom_paulson.yahalom_paulson_init_Na)->t0) in (arbitrary_init_yahalom_paulson.agent).generated_times
      t0+t1+t2 = sender.arbitrary_init_yahalom_paulson + receiver.arbitrary_init_yahalom_paulson
      t0.sender = arbitrary_init_yahalom_paulson
      ...
      let text_2  = (((t0.data).components))[1] | {
        ...
        name_1 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_a
        text_2 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Na
      }}

      t1.receiver = arbitrary_init_yahalom_paulson
      ...
      let mesg_5  = (((t1.data).components))[2] | {
        ...
        text_3 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Nb
        learnt_term_by[getLTK[arbitrary_init_yahalom_paulson.yahalom_paulson_init_a,arbitrary_init_yahalom_paulson.yahalom_paulson_init_s],arbitrary_init_yahalom_paulson.agent,t1]
        ...
        let text_11  = ((enc_4).plaintext.components)[2] | {
          ...
          name_9 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_b
          skey_10 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Kab
          text_11 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Na
        }}}
        (enc_4).encryptionKey = getLTK[arbitrary_init_yahalom_paulson.yahalom_paulson_init_a,arbitrary_init_yahalom_paulson.yahalom_paulson_init_s]
        mesg_5 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_msg
      }}}

      t2.sender = arbitrary_init_yahalom_paulson
      ...
      let enc_13  = (((t2.data).components))[1] | {
        ...
        mesg_12 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_msg
        inds[(enc_13).plaintext.components] = 0
        let text_15  = ((enc_13).plaintext.components)[0] | {
          (enc_13).plaintext.components = 0->text_15
          text_15 = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Nb
        }
        (enc_13).encryptionKey = arbitrary_init_yahalom_paulson.yahalom_paulson_init_Kab
      }}

    }}}
  }
}
sig yahalom_paulson_server extends strand {
  yahalom_paulson_server_a : one name,
  yahalom_paulson_server_b : one name,
  yahalom_paulson_server_s : one name,
  yahalom_paulson_server_Na : one text,
  yahalom_paulson_server_Nb : one text,
  yahalom_paulson_server_Kab : one skey
}
pred exec_yahalom_paulson_server {
  all arbitrary_server_yahalom_paulson : yahalom_paulson_server | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_a,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]] or generates [aStrand,getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_a,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]]
    }
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_b,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]] or generates [aStrand,getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_b,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]]
    }
    (generated_times.Timeslot).(arbitrary_server_yahalom_paulson.yahalom_paulson_server_Kab) = arbitrary_server_yahalom_paulson.agent
    arbitrary_server_yahalom_paulson.yahalom_paulson_server_a != arbitrary_server_yahalom_paulson.yahalom_paulson_server_b
    arbitrary_server_yahalom_paulson.yahalom_paulson_server_a != arbitrary_server_yahalom_paulson.yahalom_paulson_server_s
    arbitrary_server_yahalom_paulson.yahalom_paulson_server_b != arbitrary_server_yahalom_paulson.yahalom_paulson_server_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      ((arbitrary_server_yahalom_paulson.yahalom_paulson_server_Kab)->t1) in (arbitrary_server_yahalom_paulson.agent).generated_times
      t0+t1 = sender.arbitrary_server_yahalom_paulson + receiver.arbitrary_server_yahalom_paulson
      t0.receiver = arbitrary_server_yahalom_paulson
      ...
      let enc_18  = (((t0.data).components))[2] | {
        ...
        name_16 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_b
        text_17 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Nb
        learnt_term_by[getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_b,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s],arbitrary_server_yahalom_paulson.agent,t0]
        ...
        let text_22  = ((enc_18).plaintext.components)[1] | {
          ...
          name_21 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_a
          text_22 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Na
        }}
        (enc_18).encryptionKey = getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_b,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]
      }}}

      t1.sender = arbitrary_server_yahalom_paulson
      inds[((t1.data).components)] = 0+1+2
      ...
      let enc_25  = (((t1.data).components))[2] | {
        ...
        text_23 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Nb
        ...
        let text_31  = ((enc_24).plaintext.components)[2] | {
          ...
          name_29 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_b
          skey_30 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Kab
          text_31 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Na
        }}}
        (enc_24).encryptionKey = getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_a,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]
        inds[(enc_25).plaintext.components] = 0+1+2+3
        let name_36  = ((enc_25).plaintext.components)[0] | {
        let name_37  = ((enc_25).plaintext.components)[1] | {
        let skey_38  = ((enc_25).plaintext.components)[2] | {
        let text_39  = ((enc_25).plaintext.components)[3] | {
          (enc_25).plaintext.components = 0->name_36 + 1->name_37 + 2->skey_38 + 3->text_39
          name_36 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_a
          name_37 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_b
          skey_38 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Kab
          text_39 = arbitrary_server_yahalom_paulson.yahalom_paulson_server_Nb
        }}}}
        (enc_25).encryptionKey = getLTK[arbitrary_server_yahalom_paulson.yahalom_paulson_server_b,arbitrary_server_yahalom_paulson.yahalom_paulson_server_s]
      }}}

    }}
  }
}
sig yahalom_paulson_resp extends strand {
  yahalom_paulson_resp_a : one name,
  yahalom_paulson_resp_b : one name,
  yahalom_paulson_resp_s : one name,
  yahalom_paulson_resp_Na : one text,
  yahalom_paulson_resp_Nb : one text,
  yahalom_paulson_resp_Kab : one skey
}
pred exec_yahalom_paulson_resp {
  all arbitrary_resp_yahalom_paulson : yahalom_paulson_resp | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b,arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s]] or generates [aStrand,getLTK[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b,arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s]]
    }
    (generated_times.Timeslot).(arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Nb) = arbitrary_resp_yahalom_paulson.agent
    arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_a != arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b
    arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_a != arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s
    arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b != arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      ((arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Nb)->t1) in (arbitrary_resp_yahalom_paulson.agent).generated_times
      t0+t1+t2 = sender.arbitrary_resp_yahalom_paulson + receiver.arbitrary_resp_yahalom_paulson
      t0.receiver = arbitrary_resp_yahalom_paulson
      inds[((t0.data).components)] = 0+1
      let name_40  = (((t0.data).components))[0] | {
      let text_41  = (((t0.data).components))[1] | {
        ((t0.data).components) = 0->name_40 + 1->text_41
        name_40 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_a
        text_41 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Na
      }}

      t1.sender = arbitrary_resp_yahalom_paulson
      inds[((t1.data).components)] = 0+1+2
      let name_42  = (((t1.data).components))[0] | {
      let text_43  = (((t1.data).components))[1] | {
      let enc_44  = (((t1.data).components))[2] | {
        ((t1.data).components) = 0->name_42 + 1->text_43 + 2->enc_44
        name_42 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b
        text_43 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Nb
        inds[(enc_44).plaintext.components] = 0+1
        let name_47  = ((enc_44).plaintext.components)[0] | {
        let text_48  = ((enc_44).plaintext.components)[1] | {
          (enc_44).plaintext.components = 0->name_47 + 1->text_48
          name_47 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_a
          text_48 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Na
        }}
        (enc_44).encryptionKey = getLTK[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b,arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s]
      }}}

      t2.receiver = arbitrary_resp_yahalom_paulson
      inds[((t2.data).components)] = 0+1
      let enc_49  = (((t2.data).components))[0] | {
      let enc_50  = (((t2.data).components))[1] | {
        ((t2.data).components) = 0->enc_49 + 1->enc_50
        learnt_term_by[getLTK[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b,arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s],arbitrary_resp_yahalom_paulson.agent,t2]
        inds[(enc_49).plaintext.components] = 0+1+2+3
        let name_55  = ((enc_49).plaintext.components)[0] | {
        let name_56  = ((enc_49).plaintext.components)[1] | {
        let skey_57  = ((enc_49).plaintext.components)[2] | {
        let text_58  = ((enc_49).plaintext.components)[3] | {
          (enc_49).plaintext.components = 0->name_55 + 1->name_56 + 2->skey_57 + 3->text_58
          name_55 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_a
          name_56 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b
          skey_57 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Kab
          text_58 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Nb
        }}}}
        (enc_49).encryptionKey = getLTK[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_b,arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_s]
        learnt_term_by[arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Kab,arbitrary_resp_yahalom_paulson.agent,t2]
        inds[(enc_50).plaintext.components] = 0
        let text_60  = ((enc_50).plaintext.components)[0] | {
          (enc_50).plaintext.components = 0->text_60
          text_60 = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Nb
        }
        (enc_50).encryptionKey = arbitrary_resp_yahalom_paulson.yahalom_paulson_resp_Kab
      }}

    }}}
  }
}
one sig skeleton_yahalom_paulson_0 {
  skeleton_yahalom_paulson_0_a : one name,
  skeleton_yahalom_paulson_0_b : one name,
  skeleton_yahalom_paulson_0_s : one name,
  skeleton_yahalom_paulson_0_Na : one text,
  skeleton_yahalom_paulson_0_Nb : one text,
  skeleton_yahalom_paulson_0_Kab : one skey
}
pred constrain_skeleton_yahalom_paulson_0 {
  some skeleton_init_0_strand_0 : yahalom_paulson_init | {
    skeleton_init_0_strand_0.yahalom_paulson_init_a = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_a
    skeleton_init_0_strand_0.yahalom_paulson_init_b = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_b
    skeleton_init_0_strand_0.yahalom_paulson_init_s = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_s
    skeleton_init_0_strand_0.yahalom_paulson_init_Kab = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Kab
    skeleton_init_0_strand_0.yahalom_paulson_init_Na = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Na
    skeleton_init_0_strand_0.yahalom_paulson_init_Nb = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Nb
  }
  some skeleton_server_0_strand_1 : yahalom_paulson_server | {
    skeleton_server_0_strand_1.yahalom_paulson_server_a = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_a
    skeleton_server_0_strand_1.yahalom_paulson_server_b = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_b
    skeleton_server_0_strand_1.yahalom_paulson_server_s = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_s
    skeleton_server_0_strand_1.yahalom_paulson_server_Kab = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Kab
    skeleton_server_0_strand_1.yahalom_paulson_server_Na = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Na
    skeleton_server_0_strand_1.yahalom_paulson_server_Nb = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Nb
  }
  some skeleton_resp_0_strand_2 : yahalom_paulson_resp | {
    skeleton_resp_0_strand_2.yahalom_paulson_resp_a = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_a
    skeleton_resp_0_strand_2.yahalom_paulson_resp_b = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_b
    skeleton_resp_0_strand_2.yahalom_paulson_resp_s = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_s
    skeleton_resp_0_strand_2.yahalom_paulson_resp_Kab = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Kab
    skeleton_resp_0_strand_2.yahalom_paulson_resp_Na = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Na
    skeleton_resp_0_strand_2.yahalom_paulson_resp_Nb = skeleton_yahalom_paulson_0.skeleton_yahalom_paulson_0_Nb
  }
}
inst honest_run_bounds {
  ...
  yahalom_paulson_init = `yahalom_paulson_init0
  yahalom_paulson_server = `yahalom_paulson_server0
  yahalom_paulson_resp = `yahalom_paulson_resp0
  AttackerStrand = `AttackerStrand0
  strand = yahalom_paulson_init + yahalom_paulson_server + yahalom_paulson_resp + AttackerStrand
}
