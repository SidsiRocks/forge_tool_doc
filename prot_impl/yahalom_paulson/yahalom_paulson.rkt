...
(defprotocol yahalom_paulson basic
    (defrole init 
    ...
    (defrole server 
        ...
        (trace 
            ...
            (send (cat Nb (enc b Kab Na (ltk a s)) (enc a b Kab Nb (ltk b s))))
        )
        (constraint 
            (non-orig (ltk a s))
            (non-orig (ltk b s))
    ...
    (defrole resp 
        ...
        (trace 
            ...
            (recv (cat (enc a b Kab Nb (ltk b s)) (enc Nb Kab)))
        )
        (constraint 
            (non-orig (ltk b s))
