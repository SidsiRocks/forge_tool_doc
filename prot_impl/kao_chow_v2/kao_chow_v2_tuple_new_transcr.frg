...
sig kao_chow_v2_init extends strand {
  kao_chow_v2_init_a : one name,
  kao_chow_v2_init_b : one name,
  kao_chow_v2_init_s : one name,
  kao_chow_v2_init_Kab : one skey,
  kao_chow_v2_init_Kt : one skey,
  kao_chow_v2_init_Na : one text,
  kao_chow_v2_init_Nb : one text
}
pred exec_kao_chow_v2_init {
  all arbitrary_init_kao_chow_v2 : kao_chow_v2_init | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_init_kao_chow_v2.kao_chow_v2_init_a,arbitrary_init_kao_chow_v2.kao_chow_v2_init_s]] or generates [aStrand,getLTK[arbitrary_init_kao_chow_v2.kao_chow_v2_init_a,arbitrary_init_kao_chow_v2.kao_chow_v2_init_s]]
    }
    (generated_times.Timeslot).(arbitrary_init_kao_chow_v2.kao_chow_v2_init_Na) = arbitrary_init_kao_chow_v2.agent
    arbitrary_init_kao_chow_v2.kao_chow_v2_init_a != arbitrary_init_kao_chow_v2.kao_chow_v2_init_b
    arbitrary_init_kao_chow_v2.kao_chow_v2_init_a != arbitrary_init_kao_chow_v2.kao_chow_v2_init_s
    arbitrary_init_kao_chow_v2.kao_chow_v2_init_b != arbitrary_init_kao_chow_v2.kao_chow_v2_init_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      ((arbitrary_init_kao_chow_v2.kao_chow_v2_init_Na)->t0) in (arbitrary_init_kao_chow_v2.agent).generated_times
      t0+t1+t2 = sender.arbitrary_init_kao_chow_v2 + receiver.arbitrary_init_kao_chow_v2
      t0.sender = arbitrary_init_kao_chow_v2
      ...
      let text_3  = (((t0.data).components))[2] | {
        ...
        name_1 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_a
        name_2 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_b
        text_3 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Na
      }}}

      t1.receiver = arbitrary_init_kao_chow_v2
      inds[((t1.data).components)] = 0+1+2+3
      let name_4  = (((t1.data).components))[0] | {
      let enc_5  = (((t1.data).components))[1] | {
      let enc_6  = (((t1.data).components))[2] | {
      let text_7  = (((t1.data).components))[3] | {
        ((t1.data).components) = 0->name_4 + 1->enc_5 + 2->enc_6 + 3->text_7
        name_4 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_b
        learnt_term_by[getLTK[arbitrary_init_kao_chow_v2.kao_chow_v2_init_a,arbitrary_init_kao_chow_v2.kao_chow_v2_init_s],arbitrary_init_kao_chow_v2.agent,t1]
        inds[(enc_5).plaintext.components] = 0+1+2+3+4
        let name_13  = ((enc_5).plaintext.components)[0] | {
        let name_14  = ((enc_5).plaintext.components)[1] | {
        let text_15  = ((enc_5).plaintext.components)[2] | {
        let skey_16  = ((enc_5).plaintext.components)[3] | {
        let skey_17  = ((enc_5).plaintext.components)[4] | {
          (enc_5).plaintext.components = 0->name_13 + 1->name_14 + 2->text_15 + 3->skey_16 + 4->skey_17
          name_13 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_a
          name_14 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_b
          text_15 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Na
          skey_16 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kab
          skey_17 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kt
        }}}}}
        (enc_5).encryptionKey = getLTK[arbitrary_init_kao_chow_v2.kao_chow_v2_init_a,arbitrary_init_kao_chow_v2.kao_chow_v2_init_s]
        learnt_term_by[arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kt,arbitrary_init_kao_chow_v2.agent,t1]
        inds[(enc_6).plaintext.components] = 0+1
        let text_20  = ((enc_6).plaintext.components)[0] | {
        let skey_21  = ((enc_6).plaintext.components)[1] | {
          (enc_6).plaintext.components = 0->text_20 + 1->skey_21
          text_20 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Na
          skey_21 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kab
        }}
        (enc_6).encryptionKey = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kt
        text_7 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Nb
      }}}}

      t2.sender = arbitrary_init_kao_chow_v2
      inds[((t2.data)).plaintext.components] = 0+1
      let text_24  = (((t2.data)).plaintext.components)[0] | {
      let skey_25  = (((t2.data)).plaintext.components)[1] | {
        ((t2.data)).plaintext.components = 0->text_24 + 1->skey_25
        text_24 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Nb
        skey_25 = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kab
      }}
      ((t2.data)).encryptionKey = arbitrary_init_kao_chow_v2.kao_chow_v2_init_Kt

    }}}
  }
}
sig kao_chow_v2_server extends strand {
  kao_chow_v2_server_a : one name,
  kao_chow_v2_server_b : one name,
  kao_chow_v2_server_s : one name,
  kao_chow_v2_server_Kab : one skey,
  kao_chow_v2_server_Kt : one skey,
  kao_chow_v2_server_Na : one text,
  kao_chow_v2_server_Nb : one text
}
pred exec_kao_chow_v2_server {
  all arbitrary_server_kao_chow_v2 : kao_chow_v2_server | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_a,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]] or generates [aStrand,getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_a,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]]
    }
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_b,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]] or generates [aStrand,getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_b,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]]
    }
    (generated_times.Timeslot).(arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kab) = arbitrary_server_kao_chow_v2.agent
    (generated_times.Timeslot).(arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kt) = arbitrary_server_kao_chow_v2.agent
    arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kab != arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kt
    arbitrary_server_kao_chow_v2.kao_chow_v2_server_a != arbitrary_server_kao_chow_v2.kao_chow_v2_server_b
    arbitrary_server_kao_chow_v2.kao_chow_v2_server_a != arbitrary_server_kao_chow_v2.kao_chow_v2_server_s
    arbitrary_server_kao_chow_v2.kao_chow_v2_server_b != arbitrary_server_kao_chow_v2.kao_chow_v2_server_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
      ((arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kab)->t1 + (arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kt)->t1) in (arbitrary_server_kao_chow_v2.agent).generated_times
      t0+t1 = sender.arbitrary_server_kao_chow_v2 + receiver.arbitrary_server_kao_chow_v2
      t0.receiver = arbitrary_server_kao_chow_v2
      inds[((t0.data).components)] = 0+1+2
      let name_26  = (((t0.data).components))[0] | {
      let name_27  = (((t0.data).components))[1] | {
      let text_28  = (((t0.data).components))[2] | {
        ((t0.data).components) = 0->name_26 + 1->name_27 + 2->text_28
        name_26 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_a
        name_27 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_b
        text_28 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Na
      }}}

      t1.sender = arbitrary_server_kao_chow_v2
      inds[((t1.data).components)] = 0+1
      let enc_29  = (((t1.data).components))[0] | {
      let enc_30  = (((t1.data).components))[1] | {
        ((t1.data).components) = 0->enc_29 + 1->enc_30
        inds[(enc_29).plaintext.components] = 0+1+2+3+4
        let name_36  = ((enc_29).plaintext.components)[0] | {
        let name_37  = ((enc_29).plaintext.components)[1] | {
        let text_38  = ((enc_29).plaintext.components)[2] | {
        let skey_39  = ((enc_29).plaintext.components)[3] | {
        let skey_40  = ((enc_29).plaintext.components)[4] | {
          (enc_29).plaintext.components = 0->name_36 + 1->name_37 + 2->text_38 + 3->skey_39 + 4->skey_40
          name_36 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_a
          name_37 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_b
          text_38 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Na
          skey_39 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kab
          skey_40 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kt
        }}}}}
        (enc_29).encryptionKey = getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_a,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]
        inds[(enc_30).plaintext.components] = 0+1+2+3+4
        let name_46  = ((enc_30).plaintext.components)[0] | {
        let name_47  = ((enc_30).plaintext.components)[1] | {
        let text_48  = ((enc_30).plaintext.components)[2] | {
        let skey_49  = ((enc_30).plaintext.components)[3] | {
        let skey_50  = ((enc_30).plaintext.components)[4] | {
          (enc_30).plaintext.components = 0->name_46 + 1->name_47 + 2->text_48 + 3->skey_49 + 4->skey_50
          name_46 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_a
          name_47 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_b
          text_48 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Na
          skey_49 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kab
          skey_50 = arbitrary_server_kao_chow_v2.kao_chow_v2_server_Kt
        }}}}}
        (enc_30).encryptionKey = getLTK[arbitrary_server_kao_chow_v2.kao_chow_v2_server_b,arbitrary_server_kao_chow_v2.kao_chow_v2_server_s]
      }}

    }}
  }
}
sig kao_chow_v2_resp extends strand {
  kao_chow_v2_resp_a : one name,
  kao_chow_v2_resp_b : one name,
  kao_chow_v2_resp_s : one name,
  kao_chow_v2_resp_Kab : one skey,
  kao_chow_v2_resp_Kt : one skey,
  kao_chow_v2_resp_Na : one text,
  kao_chow_v2_resp_Nb : one text,
  kao_chow_v2_resp_msg : one mesg
}
pred exec_kao_chow_v2_resp {
  all arbitrary_resp_kao_chow_v2 : kao_chow_v2_resp | {
    no aStrand : strand | {
      originates[aStrand,getLTK[arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b,arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s]] or generates [aStrand,getLTK[arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b,arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s]]
    }
    (generated_times.Timeslot).(arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Nb) = arbitrary_resp_kao_chow_v2.agent
    arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_a != arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b
    arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_a != arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s
    arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b != arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s
    some t0 : Timeslot {
    some t1 : t0.(^next) {
    some t2 : t1.(^next) {
      ((arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Nb)->t1) in (arbitrary_resp_kao_chow_v2.agent).generated_times
      t0+t1+t2 = sender.arbitrary_resp_kao_chow_v2 + receiver.arbitrary_resp_kao_chow_v2
      t0.receiver = arbitrary_resp_kao_chow_v2
      inds[((t0.data).components)] = 0+1
      let mesg_51  = (((t0.data).components))[0] | {
      let enc_52  = (((t0.data).components))[1] | {
        ((t0.data).components) = 0->mesg_51 + 1->enc_52
        mesg_51 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_msg
        learnt_term_by[getLTK[arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b,arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s],arbitrary_resp_kao_chow_v2.agent,t0]
        inds[(enc_52).plaintext.components] = 0+1+2+3+4
        let name_58  = ((enc_52).plaintext.components)[0] | {
        let name_59  = ((enc_52).plaintext.components)[1] | {
        let text_60  = ((enc_52).plaintext.components)[2] | {
        let skey_61  = ((enc_52).plaintext.components)[3] | {
        let skey_62  = ((enc_52).plaintext.components)[4] | {
          (enc_52).plaintext.components = 0->name_58 + 1->name_59 + 2->text_60 + 3->skey_61 + 4->skey_62
          name_58 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_a
          name_59 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b
          text_60 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Na
          skey_61 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kab
          skey_62 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kt
        }}}}}
        (enc_52).encryptionKey = getLTK[arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b,arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_s]
      }}

      t1.sender = arbitrary_resp_kao_chow_v2
      inds[((t1.data).components)] = 0+1+2+3
      let name_63  = (((t1.data).components))[0] | {
      let mesg_64  = (((t1.data).components))[1] | {
      let enc_65  = (((t1.data).components))[2] | {
      let text_66  = (((t1.data).components))[3] | {
        ((t1.data).components) = 0->name_63 + 1->mesg_64 + 2->enc_65 + 3->text_66
        name_63 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_b
        mesg_64 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_msg
        inds[(enc_65).plaintext.components] = 0+1
        let text_69  = ((enc_65).plaintext.components)[0] | {
        let skey_70  = ((enc_65).plaintext.components)[1] | {
          (enc_65).plaintext.components = 0->text_69 + 1->skey_70
          text_69 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Na
          skey_70 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kab
        }}
        (enc_65).encryptionKey = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kt
        text_66 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Nb
      }}}}

      t2.receiver = arbitrary_resp_kao_chow_v2
      learnt_term_by[arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kt,arbitrary_resp_kao_chow_v2.agent,t2]
      inds[((t2.data)).plaintext.components] = 0+1
      let text_73  = (((t2.data)).plaintext.components)[0] | {
      let skey_74  = (((t2.data)).plaintext.components)[1] | {
        ((t2.data)).plaintext.components = 0->text_73 + 1->skey_74
        text_73 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Nb
        skey_74 = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kab
      }}
      ((t2.data)).encryptionKey = arbitrary_resp_kao_chow_v2.kao_chow_v2_resp_Kt

    }}}
  }
}
one sig skeleton_kao_chow_v2_0 {
  skeleton_kao_chow_v2_0_a : one name,
  skeleton_kao_chow_v2_0_b : one name,
  skeleton_kao_chow_v2_0_s : one name,
  skeleton_kao_chow_v2_0_Kab : one skey,
  skeleton_kao_chow_v2_0_Kt : one skey,
  skeleton_kao_chow_v2_0_Na : one text,
  skeleton_kao_chow_v2_0_Nb : one text
}
pred constrain_skeleton_kao_chow_v2_0 {
  some skeleton_init_0_strand_0 : kao_chow_v2_init | {
    skeleton_init_0_strand_0.kao_chow_v2_init_a = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_a
    skeleton_init_0_strand_0.kao_chow_v2_init_b = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_b
    skeleton_init_0_strand_0.kao_chow_v2_init_s = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_s
    skeleton_init_0_strand_0.kao_chow_v2_init_Kab = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kab
    skeleton_init_0_strand_0.kao_chow_v2_init_Kt = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kt
    skeleton_init_0_strand_0.kao_chow_v2_init_Na = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Na
    skeleton_init_0_strand_0.kao_chow_v2_init_Nb = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Nb
  }
  some skeleton_server_0_strand_1 : kao_chow_v2_server | {
    skeleton_server_0_strand_1.kao_chow_v2_server_a = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_a
    skeleton_server_0_strand_1.kao_chow_v2_server_b = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_b
    skeleton_server_0_strand_1.kao_chow_v2_server_s = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_s
    skeleton_server_0_strand_1.kao_chow_v2_server_Kab = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kab
    skeleton_server_0_strand_1.kao_chow_v2_server_Kt = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kt
    skeleton_server_0_strand_1.kao_chow_v2_server_Na = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Na
  }
  some skeleton_resp_0_strand_2 : kao_chow_v2_resp | {
    skeleton_resp_0_strand_2.kao_chow_v2_resp_a = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_a
    skeleton_resp_0_strand_2.kao_chow_v2_resp_b = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_b
    skeleton_resp_0_strand_2.kao_chow_v2_resp_s = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_s
    skeleton_resp_0_strand_2.kao_chow_v2_resp_Kab = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kab
    skeleton_resp_0_strand_2.kao_chow_v2_resp_Kt = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Kt
    skeleton_resp_0_strand_2.kao_chow_v2_resp_Na = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Na
    skeleton_resp_0_strand_2.kao_chow_v2_resp_Nb = skeleton_kao_chow_v2_0.skeleton_kao_chow_v2_0_Nb
  }
}
inst honest_run_bounds {
  ...
  kao_chow_v2_init = `kao_chow_v2_init0
  kao_chow_v2_server = `kao_chow_v2_server0
  kao_chow_v2_resp = `kao_chow_v2_resp0
  AttackerStrand = `AttackerStrand0
  strand = kao_chow_v2_init + kao_chow_v2_server + kao_chow_v2_resp + AttackerStrand
}
