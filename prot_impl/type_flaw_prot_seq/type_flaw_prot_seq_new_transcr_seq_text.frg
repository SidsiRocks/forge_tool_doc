...
pred constrain_skeleton_type_flaw_prot_1 {
  ...
  no aStrand : strand | {
    originates[aStrand,getPRIVK[skeleton_type_flaw_prot_1.skeleton_type_flaw_prot_1_a]] or generates [aStrand,getPRIVK[skeleton_type_flaw_prot_1.skeleton_type_flaw_prot_1_a]]
  }
  no aStrand : strand | {
    originates[aStrand,getPRIVK[Attacker]] or generates [aStrand,getPRIVK[Attacker]]
  }
