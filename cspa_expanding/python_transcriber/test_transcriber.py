...
def test_addit_enc_transcr():
    cpsa_file_path = path_rel_to_script( "../../prot_impl/additional_enc_test/addit_enc.rkt" )
    base_file_path = path_rel_to_script("./base_with_seq.frg")
    extra_func_file_path = path_rel_to_script( "./extra_funcs.frg" )
    run_forge_file_path = path_rel_to_script( "../../prot_impl/additional_enc_test/addit_enc.frg"  )

    destination_forge_file = io.StringIO()
    reference_transcription_file = path_rel_to_script( "../../prot_impl/additional_enc_test/addit_enc_new_transcr.frg"  )
        ...
        with open(base_file_path) as base_file:
            with open(extra_func_file_path) as extra_func_file:
                with open(run_forge_file_path) as run_forge_file:
                    main(cpsa_file,destination_forge_file,base_file,extra_func_file,run_forge_file,False,None)
